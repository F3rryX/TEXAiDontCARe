...
public class SVGParser extends DefaultHandler2 {
    ...
    static {
        ...
        colourKeywords.put("mediumblue", Integer.valueOf(Constants.PENDING_INTENT_REQUEST_CODE_LOGIN_AFTER_REFRESH_TOKEN_EXPIRED));
        ...
        HashMap<String, Integer> map = fontWeightKeywords;
        Integer numValueOf = Integer.valueOf(SVG.Style.FONT_WEIGHT_NORMAL);
        map.put("normal", numValueOf);
        HashMap<String, Integer> map2 = fontWeightKeywords;
        Integer numValueOf2 = Integer.valueOf(SVG.Style.FONT_WEIGHT_BOLD);
        map2.put("bold", numValueOf2);
        ...
        fontWeightKeywords.put("300", Integer.valueOf(FcmConstants.ID_REMEMBER_TO_ACCEPT_TERMS_OF_SERVICE));
        fontWeightKeywords.put("400", numValueOf);
        fontWeightKeywords.put("500", 500);
        fontWeightKeywords.put("600", 600);
        fontWeightKeywords.put("700", numValueOf2);
    ...
    protected SVG parse(InputStream inputStream) throws SVGParseException {
    ...
    */
    ...
    private void parseAttributesCore(SVG.SvgElementBase svgElementBase, Attributes attributes) throws SAXException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            if (qName.equals("xml:space")) {
                String strTrim = attributes.getValue(i).trim();
                if (GsonDTCLocaleSerializer.LOCALE_DEFAULT_PLACEHOLDER.equals(strTrim)) {
    ...
    protected static void processStyleProperty(SVG.Style style, String str, String str2) throws SAXException {
        ...
        if (i == 75) {
            ...
            style.specifiedFlags |= MockDataID.Parameter.ENGINE_RPM;
            return;
        }
        if (i == 76) {
            style.textDecoration = parseTextDecoration(str2);
            style.specifiedFlags |= MockDataID.Parameter.VEHICLE_SPEED;
            return;
        }
        switch (i) {
            case 15:
            ...
            case 23:
                ...
                style.specifiedFlags |= MockDataID.Status.BRAKE_PAD_LAMP_STATUS;
                return;
            default:
                switch (i) {
                    case 29:
        ...
        if (str.charAt(0) == '#') {
            try {
                ...
                if (str.length() == 4) {
                    ...
                    int i2 = i & 3840;
                    int i3 = i & Commands.GetSOSStatus;
                    int i4 = i & 15;
    ...
    private static void parseFont(SVG.Style style, String str) throws SAXException {
        ...
        style.fontWeight = Integer.valueOf(num == null ? SVG.Style.FONT_WEIGHT_NORMAL : num.intValue());
        if (fontStyle == null) {
    ...
    private static SVG.PathDefinition parsePath(String str) throws SAXException {
        ...
        while (true) {
            ...
            switch (iIntValue2) {
                ...
                case 83:
                case 115:
                    Float fValueOf = Float.valueOf((fFloatValue * 2.0f) - fFloatValue2);
                    Float fValueOf2 = Float.valueOf((2.0f * fFloatValue3) - fFloatValue4);
                    Float fNextFloat7 = textScanner.nextFloat();
                    ...
                    if (fCheckedNextFloat17 == null) {
                        ...
                        Float f6 = fNextFloat7;
                        Float f7 = fCheckedNextFloat16;
                        Float f8 = fCheckedNextFloat15;
                        pathDefinition.cubicTo(fValueOf.floatValue(), fValueOf2.floatValue(), f6.floatValue(), f8.floatValue(), f7.floatValue(), fCheckedNextFloat17.floatValue());
                        fFloatValue2 = f6.floatValue();
                        fFloatValue4 = f8.floatValue();
                ...
                case 84:
                case 116:
                    Float fValueOf3 = Float.valueOf((fFloatValue * 2.0f) - fFloatValue2);
                    Float fValueOf4 = Float.valueOf((2.0f * fFloatValue3) - fFloatValue4);
                    Float fNextFloat8 = textScanner.nextFloat();
                    ...
                    if (fCheckedNextFloat18 == null) {
                        ...
                        pathDefinition.quadTo(fValueOf3.floatValue(), fValueOf4.floatValue(), fNextFloat8.floatValue(), fCheckedNextFloat18.floatValue());
                        fFloatValue2 = fValueOf3.floatValue();
                        fFloatValue4 = fValueOf4.floatValue();
