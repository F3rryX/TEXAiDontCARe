...
final class CctTransportBackend implements TransportBackend {
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        ...
        httpURLConnection.setRequestProperty(TexaCareServiceBus.HEADER_USER_AGENT, String.format("datatransport/%s android/", "3.1.0"));
        ...
        try {
            ...
            return new HttpResponse(SVG.Style.FONT_WEIGHT_NORMAL, null, 0L);
