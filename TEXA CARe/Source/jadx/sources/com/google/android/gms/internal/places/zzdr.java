...
public final class zzdr {
    ...
    final void zzb(zzel zzelVar) throws IOException {
    ...
    public final int zzdj() {
        ...
        int iZze = 0;
        for (int i2 = 0; i2 < this.count; i2++) {
            iZze += zzaj.zze(this.zzmi[i2] >>> 3, (zzw) this.zzkt[i2]);
        }
        this.zzii = iZze;
        return iZze;
    }
    ...
    public final int zzbh() {
        ...
        for (int i3 = 0; i3 < this.count; i3++) {
            ...
            int i6 = i4 & 7;
            if (i6 == 0) {
                iZzf = zzaj.zzf(i5, ((Long) this.zzkt[i3]).longValue());
            } else if (i6 == 1) {
                iZzf = zzaj.zzh(i5, ((Long) this.zzkt[i3]).longValue());
            } else if (i6 == 2) {
                iZzf = zzaj.zzd(i5, (zzw) this.zzkt[i3]);
            } else if (i6 == 3) {
                iZzf = (zzaj.zzr(i5) << 1) + ((zzdr) this.zzkt[i3]).zzbh();
            } else if (i6 == 5) {
                iZzf = zzaj.zzk(i5, ((Integer) this.zzkt[i3]).intValue());
            } else {
