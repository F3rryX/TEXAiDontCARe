    ...
    */
    final List<com.google.android.gms.internal.measurement.zzfk> zza(String str, List<com.google.android.gms.internal.measurement.zzfo> list, List<com.google.android.gms.internal.measurement.zzgh> list2, Long l, Long l2) throws Throwable {
        ...
        if (z) {
            ...
            try {
                r52 = new String[]{str12};
                zzajVarZzi2.zzh().update("events", contentValues, "app_id = ?", r52);
                r5 = r52;
        ...
        String str15 = Constants.ScionAnalytics.MessageType.DATA_MESSAGE;
        ...
        if (zZzs2 && zZzs) {
            ...
            try {
                try {
                    cursorQuery4 = zzajVarZzi3.zzh().query("event_filters", new String[]{"audience_id", Constants.ScionAnalytics.MessageType.DATA_MESSAGE}, "app_id=?", new String[]{str17}, null, null, null);
                    try {
        ...
        if (!map2.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (zzgdVar2 != null && zzgdVar2.zzc() != 0) {
                    Iterator<com.google.android.gms.internal.measurement.zzgf> it10 = zzgdVar2.zzm().iterator();
                    while (it10.hasNext()) {
                        com.google.android.gms.internal.measurement.zzgf next = it10.next();
        ...
        zzu zzuVar22 = null;
        if (!list.isEmpty()) {
            zzv zzvVar2 = new zzv(this, zzuVar22);
            ArrayMap arrayMap9 = new ArrayMap();
            Iterator<com.google.android.gms.internal.measurement.zzfo> it11 = list.iterator();
            while (it11.hasNext()) {
                com.google.android.gms.internal.measurement.zzfo next2 = it11.next();
                ...
                if (zzfoVarZza != null) {
                    ...
                    if (mapEmptyMap4 == null) {
                        ...
                        zzvVar = zzvVar2;
                        it4 = it11;
                        String str29 = str2022;
                        String str30 = str2122;
                        try {
                            try {
                                str7 = str11;
                                try {
                                    ...
                                    str8 = str1922;
                                    cursorQuery2 = null;
                                    zzajVarZzi6.zzs.zzay().zzd().zzc(str1822, zzel.zzn(str28), e);
                    ...
                    while (it5.hasNext()) {
                        ...
                        if (set.contains(numValueOf7)) {
                            ...
                            while (true) {
                                ...
                                com.google.android.gms.internal.measurement.zzej zzejVar2 = (com.google.android.gms.internal.measurement.zzej) it12.next();
        ...
        if (!list2.isEmpty()) {
            ...
            Iterator<com.google.android.gms.internal.measurement.zzgh> it13 = list2.iterator();
            while (it13.hasNext()) {
                com.google.android.gms.internal.measurement.zzgh next3 = it13.next();
                        ...
                        while (true) {
                            try {
                                ...
                                try {
                                    ...
                                    e = e22;
                                    zzajVarZzi7.zzs.zzay().zzd().zzc(str1822, zzel.zzn(str31), e);
                ...
                Iterator it14 = mapEmptyMap5.keySet().iterator();
                while (true) {
                    if (it14.hasNext()) {
                        int iIntValue4 = ((Integer) it14.next()).intValue();
        ...
        while (it8.hasNext()) {
            ...
            contentValues2.put(str2322, numValueOf10);
