...
public final class zzfe {
    ...
    static zzfe zzb(zzfe zzfeVar, zzfe zzfeVar2) {
        int i = zzfeVar.zzb;
        int i2 = zzfeVar2.zzb;
        int[] iArrCopyOf = Arrays.copyOf(zzfeVar.zzc, 0);
        int[] iArr = zzfeVar2.zzc;
        int i3 = zzfeVar.zzb;
        int i4 = zzfeVar2.zzb;
        System.arraycopy(iArr, 0, iArrCopyOf, 0, 0);
        Object[] objArrCopyOf = Arrays.copyOf(zzfeVar.zzd, 0);
        Object[] objArr = zzfeVar2.zzd;
        int i5 = zzfeVar.zzb;
        int i6 = zzfeVar2.zzb;
        System.arraycopy(objArr, 0, objArrCopyOf, 0, 0);
        return new zzfe(0, iArrCopyOf, objArrCopyOf, true);
    }
