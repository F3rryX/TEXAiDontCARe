...
public abstract class zzaj extends zzt {
    ...
    abstract void zzb(int i, zzck zzckVar, zzda zzdaVar) throws IOException;
        ...
        public final void zzc(long j) throws IOException {
            if (zzaj.zzer && zzak() >= 10) {
                while ((j & (-128)) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    zzdy.zzb(bArr, i, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
        ...
        public final void zzj(String str) throws IOException {
            ...
            try {
                ...
                if (iZzt2 == iZzt) {
                    int i2 = i + iZzt2;
                    this.position = i2;
                    int iZzb = zzea.zzb(str, this.buffer, i2, zzak());
                    this.position = i;
                    zzo((iZzb - i) - iZzt2);
                    this.position = iZzb;
                    return;
    ...
    static int zzc(int i, zzck zzckVar, zzda zzdaVar) {
    ...
    @Deprecated
    static int zzd(int i, zzck zzckVar, zzda zzdaVar) {
        int iZzr = zzr(i) << 1;
        zzm zzmVar = (zzm) zzckVar;
        int iZzw = zzmVar.zzw();
        if (iZzw == -1) {
