...
public final class zznh implements zzng {
    ...
    static {
        ...
        zzy = zzhrVar.zzc("measurement.upload.max_bundle_size", MockDataID.Status.BRAKE_PAD_LAMP_STATUS);
        ...
        zzH = zzhrVar.zzc("measurement.upload.max_batch_size", MockDataID.Status.BRAKE_PAD_LAMP_STATUS);
