...
public final class zzx extends AbstractSafeParcelable {
    ...
    public static zzf zzb(Intent intent, String str, Uri uri, String str2, List<AppIndexApi.AppIndexingLink> list) {
        ...
        if (uri != null) {
            ...
            zzfVar.zza(new zzk(string2, zzrVar2.zze(), zzk.zza, null));
        }
        if (list != null) {
            zzan zzanVarZza = zzaq.zza();
            int size = list.size();
            zzap[] zzapVarArr = new zzap[size];
            for (int i = 0; i < size; i++) {
                zzao zzaoVarZza = zzap.zza();
                AppIndexApi.AppIndexingLink appIndexingLink = list.get(i);
                zzaoVarZza.zza(appIndexingLink.appIndexingUrl.toString());
                zzaoVarZza.zzc(appIndexingLink.viewId);
                Uri uri2 = appIndexingLink.webUrl;
                if (uri2 != null) {
                    zzaoVarZza.zzb(uri2.toString());
                }
                zzapVarArr[i] = zzaoVarZza.zzj();
            }
            zzanVarZza.zza(Arrays.asList(zzapVarArr));
            byte[] bArrZzh = zzanVarZza.zzj().zzh();
            zzr zzrVar3 = new zzr("outlinks");
            zzrVar3.zzb(true);
            zzrVar3.zzd(".private:outLinks");
            zzrVar3.zza("blob");
            zzfVar.zza(new zzk(null, zzrVar3.zze(), zzk.zza, bArrZzh));
        }
