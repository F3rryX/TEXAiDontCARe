    ...
    public static final class Builder {
        ...
        public final GoogleApiClient build() {
            ...
            for (Api<?> api2 : this.zak.keySet()) {
                ...
                Api.Client clientBuildClient = abstractClientBuilder.buildClient(this.zaj, this.zao, clientSettingsBuildClientSettings, apiOptions, (ConnectionCallbacks) zaqVar, (OnConnectionFailedListener) zaqVar);
