...
public final class zzv extends zzai {
    ...
    public final zzap zza(zzg zzgVar, List<zzap> list) {
        ...
        this.zza.zza(strZzi, zzamVar.zzt(ContactModel.COLUMN_PRIORITY) ? zzh.zzb(zzamVar.zzf(ContactModel.COLUMN_PRIORITY).zzh().doubleValue()) : 1000, (zzao) zzapVarZzb, zzamVar.zzf("type").zzi());
        return zzap.zzf;
    }
}
