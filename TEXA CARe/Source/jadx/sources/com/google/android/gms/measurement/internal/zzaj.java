    ...
    final void zzC(String str, List<com.google.android.gms.internal.measurement.zzeh> list) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                int iMax = Math.max(0, Math.min(MockVehicleInfo.DELAY_DATA_UPDATED, this.zzs.zzf().zze(str, zzdy.zzE)));
                if (jZzab > iMax) {
        ...
        try {
            try {
                ...
                try {
                    ...
                    String str4 = string;
                    try {
                        Cursor cursorQuery = sQLiteDatabaseZzh.query("raw_events_metadata", new String[]{"metadata"}, "app_id = ? and metadata_fingerprint = ?", new String[]{string2, str4}, null, null, "rowid", ExifInterface.GPS_MEASUREMENT_2D);
                        try {
                            ...
                            try {
                                try {
                                    ...
                                    Cursor cursorQuery2 = sQLiteDatabaseZzh.query("raw_events", new String[]{"rowid", AppMeasurementSdk.ConditionalUserProperty.NAME, "timestamp", Constants.ScionAnalytics.MessageType.DATA_MESSAGE}, str3, strArr, null, null, "rowid", null);
        ...
        try {
            try {
                ...
                try {
                    ...
                    this.zzs.zzf();
                    cursorQuery = sQLiteDatabaseZzh.query("user_attributes", strArr2, string2, strArr, null, null, "rowid", "1001");
                    if (!cursorQuery.moveToFirst()) {
                        return arrayList;
                    }
                    while (true) {
                        ...
                        if (size < 1000) {
                            ...
                            if (objZzq == null) {
                                ...
                                arrayList.add(new zzkx(str, string, string3, j, objZzq));
                            }
                            if (!cursorQuery.moveToNext()) {
                                break;
                            }
