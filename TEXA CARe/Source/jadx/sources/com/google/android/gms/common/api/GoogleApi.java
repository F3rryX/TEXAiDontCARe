...
public class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    public GoogleApi(Activity activity, Api<O> api, O o, Settings settings) {
        ...
        String strZaa = zaa(activity);
        this.zab = strZaa;
        this.zac = api;
        this.zad = o;
        this.zaf = settings.zab;
        ApiKey<O> apiKeyZaa = ApiKey.zaa(api, o, strZaa);
        this.zae = apiKeyZaa;
        ...
        if (!(activity instanceof GoogleApiActivity) && Looper.myLooper() == Looper.getMainLooper()) {
            zay.zaa(activity, googleApiManagerZaa, apiKeyZaa);
        }
    ...
    public final Api.Client zaa(Looper looper, GoogleApiManager.zaa<O> zaaVar) {
        Api.Client clientBuildClient = ((Api.AbstractClientBuilder) Preconditions.checkNotNull(this.zac.zab())).buildClient(this.zaa, looper, createClientSettingsBuilder().build(), this.zad, (GoogleApiClient.ConnectionCallbacks) zaaVar, (GoogleApiClient.OnConnectionFailedListener) zaaVar);
