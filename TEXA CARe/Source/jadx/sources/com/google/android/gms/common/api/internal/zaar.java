...
public final class zaar extends GoogleApiClient implements zabn {
    ...
    public final ConnectionResult getConnectionResult(Api<?> api) {
        ...
        try {
            ...
            if (this.zab.containsKey(api.zac())) {
                ConnectionResult connectionResultZaa = ((zabo) Preconditions.checkNotNull(this.zah)).zaa(api);
    ...
    public final PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        if (this.zab.containsKey(Common.CLIENT_KEY)) {
            ...
            GoogleApiClient googleApiClientBuild = new GoogleApiClient.Builder(this.zaj).addApi(Common.API).addConnectionCallbacks(new zaat(this, atomicReference, statusPendingResult)).addOnConnectionFailedListener(new zaas(this, statusPendingResult)).setHandler(this.zao).build();
