...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public Task<Void> makeGooglePlayServicesAvailable(Activity activity) {
        ...
        zabp zabpVarZaa = zabp.zaa(activity);
        zabpVarZaa.zab(new ConnectionResult(iIsGooglePlayServicesAvailable, null), 0);
        return zabpVarZaa.zac();
    }
    ...
    public final boolean zaa(Activity activity, LifecycleFragment lifecycleFragment, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        Dialog dialogZaa = zaa(activity, i, com.google.android.gms.common.internal.zab.zaa(lifecycleFragment, getErrorResolutionIntent(activity, i, "d"), 2), onCancelListener);
        if (dialogZaa == null) {
            return false;
        }
    ...
    static Dialog zaa(Context context, int i, com.google.android.gms.common.internal.zab zabVar, DialogInterface.OnCancelListener onCancelListener) {
        if (i == 0) {
            return null;
        }
