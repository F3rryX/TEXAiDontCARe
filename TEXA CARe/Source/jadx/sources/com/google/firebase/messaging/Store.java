    ...
    static class Token {
        ...
        static String encode(String str, String str2, long j) {
            try {
                ...
                jSONObject.put(com.texa.careapp.Constants.GCM_PROPERTY_APP_VERSION, str2);
        ...
        static Token parse(String str) {
            ...
            try {
                ...
                return new Token(jSONObject.getString("token"), jSONObject.getString(com.texa.careapp.Constants.GCM_PROPERTY_APP_VERSION), jSONObject.getLong("timestamp"));
            } catch (JSONException e) {
