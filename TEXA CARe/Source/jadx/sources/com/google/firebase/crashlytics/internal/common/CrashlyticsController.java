...
class CrashlyticsController {
    ...
    public void doOpenSession() {
        ...
        this.nativeComponent.prepareNativeSession(string, String.format(Locale.US, GENERATOR_FORMAT, CrashlyticsCore.getVersion()), currentTimestampSeconds, StaticSessionData.create(createAppData(this.idManager, this.appData), createOsData(getContext()), createDeviceData(getContext())));
