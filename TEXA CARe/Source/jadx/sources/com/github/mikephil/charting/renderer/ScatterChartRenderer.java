        ...
        if (isDrawingValuesAllowed(this.mChart)) {
            ...
            for (int i = 0; i < this.mChart.getScatterData().getDataSetCount(); i++) {
                ...
                if (shouldDrawValues(iScatterDataSet2) && iScatterDataSet2.getEntryCount() >= 1) {
                    ...
                    float[] fArrGenerateTransformedValuesScatter = this.mChart.getTransformer(iScatterDataSet2.getAxisDependency()).generateTransformedValuesScatter(iScatterDataSet2, this.mAnimator.getPhaseX(), this.mAnimator.getPhaseY(), this.mXBounds.min, this.mXBounds.max);
