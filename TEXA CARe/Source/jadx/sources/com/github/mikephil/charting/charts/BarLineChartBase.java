...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    protected void init() {
        ...
        this.mGridBackgroundPaint.setColor(Color.rgb(Commands.GetSOSStatus, Commands.GetSOSStatus, Commands.GetSOSStatus));
    ...
    /* JADX WARN: Type inference failed for: r2v10, types: [com.github.mikephil.charting.components.XAxis, lombok.launch.PatchFixesHider$Delegate] */
    /* JADX WARN: Type inference failed for: r2v11, types: [void] */
    /* JADX WARN: Type inference failed for: r3v3, types: [com.github.mikephil.charting.components.XAxis, lombok.launch.PatchFixesHider$Delegate] */
    ...
    /* JADX WARN: Type inference failed for: r1v17, types: [com.github.mikephil.charting.components.XAxis, lombok.launch.PatchFixesHider$Delegate] */
    ...
    public void calculateOffsets() {
        if (!this.mCustomViewPortEnabled) {
            ...
            float requiredWidthSpace = this.mOffsetsBuffer.right + 0.0f;
            float f3 = this.mOffsetsBuffer.bottom + 0.0f;
            ?? requiredWidthSpace2 = f;
            if (this.mAxisLeft.needsOffset()) {
                requiredWidthSpace2 = f + this.mAxisLeft.getRequiredWidthSpace(this.mAxisRendererLeft.getPaintAxisLabels());
            }
            if (this.mAxisRight.needsOffset()) {
                requiredWidthSpace += this.mAxisRight.getRequiredWidthSpace(this.mAxisRendererRight.getPaintAxisLabels());
            }
            if (this.mXAxis.isEnabled() && this.mXAxis.handleDelegateForType(requiredWidthSpace2)) {
            ...
            float extraRightOffset = requiredWidthSpace + getExtraRightOffset();
            float extraBottomOffset = f3 + getExtraBottomOffset();
            float extraLeftOffset = requiredWidthSpace2 + getExtraLeftOffset();
