...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntry> implements IBarDataSet {
    ...
    public BarDataSet(List<BarEntry> list, String str) {
        super(list, str);
        this.mStackSize = 1;
        this.mBarShadowColor = Color.rgb(Commands.DPMC_GetSupportedDiagnosticProcedures, Commands.DPMC_GetSupportedDiagnosticProcedures, Commands.DPMC_GetSupportedDiagnosticProcedures);
