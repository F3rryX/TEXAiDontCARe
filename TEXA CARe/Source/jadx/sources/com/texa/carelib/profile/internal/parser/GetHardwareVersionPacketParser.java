...
public final class GetHardwareVersionPacketParser {
    private static final boolean D = false;
    public static final String TAG = "GetHardwareVersionPacketParser";

    private GetHardwareVersionPacketParser() {
    }

    public static Version parse(Message message) {
