...
public class EmergencyInfoMessageJob extends Worker {
    ...
    public EmergencyInfoMessageJob(Context context, WorkerParameters workerParameters) {
    ...
    public ListenableWorker.Result doWork() {
        ...
        try {
            Timber.d("addEmergencyMessagesBlocking response: %s", this.texaCareApiServiceUser.addEmergencyMessagesBlocking(emergencyInfo).execute().body());
            deleteCachedEmergencyInfo();
            return ListenableWorker.Result.success();
        } catch (Exception e) {
            Timber.w(e, "addEmergencyMessagesBlocking exception", new Object[0]);
