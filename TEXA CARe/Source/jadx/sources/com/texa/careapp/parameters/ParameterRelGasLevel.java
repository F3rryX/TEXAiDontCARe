...
public class ParameterRelGasLevel extends ParametersNoChart {
    private static final String TAG = "ParameterRelGasLevel";
    ...
    public ParameterRelGasLevel(Context context) {
        this.mLabel = context.getString(R.string.rel_gas_level);
    ...
    public int getPriority() {
        return Constants.CARE_DRIVER_PARAMETERS.indexOf(Long.valueOf(DataID.Parameter.REL_GAS_LEVEL.getId()));
    }
}
