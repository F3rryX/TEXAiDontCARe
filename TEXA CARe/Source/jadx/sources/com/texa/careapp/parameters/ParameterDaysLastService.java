...
public class ParameterDaysLastService extends ParametersNoChart {
    private static final String TAG = "ParameterDaysLastService";
    ...
    public ParameterDaysLastService(Context context) {
        this.mLabel = context.getString(R.string.days_last_service);
        this.mUnit = context.getString(R.string.unit_days);
    }
    ...
    public int getPriority() {
        return Constants.CARE_DRIVER_PARAMETERS.indexOf(Long.valueOf(DataID.Parameter.DAYS_LAST_SERVICE.getId()));
    }
}
