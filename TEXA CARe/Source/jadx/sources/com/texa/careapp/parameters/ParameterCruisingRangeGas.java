...
public class ParameterCruisingRangeGas extends ParametersNoChart {
    private static final String TAG = "ParameterCruisingRangeGas";
    ...
    public ParameterCruisingRangeGas(Context context) {
        this.mLabel = context.getString(R.string.cruising_range_gas);
    ...
    public int getPriority() {
        return Constants.CARE_DRIVER_PARAMETERS.indexOf(Long.valueOf(DataID.Parameter.CRUISING_RANGE_GAS.getId()));
    }
}
