...
public class ParameterDistanceLastService extends ParametersNoChart {
    private static final String TAG = "ParameterDistanceLastService";
    ...
    public ParameterDistanceLastService(Context context) {
        this.mLabel = context.getString(R.string.distance_last_service);
    ...
    public int getPriority() {
        return Constants.CARE_DRIVER_PARAMETERS.indexOf(Long.valueOf(DataID.Parameter.DISTANCE_LAST_SERVICE.getId()));
    }
}
