...
public class ActivityOnBoardingBindingImpl extends ActivityOnBoardingBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.activity_on_boarding_header, 1);
        sparseIntArray.put(R.id.activity_on_boarding_back_btn, 2);
        sparseIntArray.put(R.id.activity_on_boarding_container, 3);
    }
    ...
    private ActivityOnBoardingBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (ImageView) objArr[2], (FrameLayout) objArr[3], (RelativeLayout) objArr[1]);
        this.mDirtyFlags = -1L;
