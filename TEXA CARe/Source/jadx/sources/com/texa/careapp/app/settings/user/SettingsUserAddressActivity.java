...
public class SettingsUserAddressActivity extends BaseActivity {
    ...
    public static Intent buildIntent(Context context) {
        ...
        Intent intent = new Intent(context, (Class<?>) SettingsUserAddressActivity.class);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_settings_user_address_layout);
        ...
        instanceFor.setContainerResId(R.id.settings_user_address_container);
        instanceFor.goTo(new SettingsUserAddressScreen());
    }
}
