...
public class SettingsCareActivity extends BaseActivity {
    ...
    public static Intent buildIntent(Context context) {
        ...
        Intent intent = new Intent(context, (Class<?>) SettingsCareActivity.class);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.mNavigator.goTo(new SettingsCareScreen(this));
    }
