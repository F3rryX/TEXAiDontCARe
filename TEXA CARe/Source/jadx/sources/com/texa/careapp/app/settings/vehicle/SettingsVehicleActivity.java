...
public class SettingsVehicleActivity extends BaseActivity {
    ...
    public static Intent buildIntent(Context context) {
        ...
        Intent intent = new Intent(context, (Class<?>) SettingsVehicleActivity.class);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_settings_vehicle_layout);
        ...
        instanceFor.setContainerResId(R.id.settings_vehicle_container);
        instanceFor.goTo(new SettingsVehicleScreen(this));
    }
}
