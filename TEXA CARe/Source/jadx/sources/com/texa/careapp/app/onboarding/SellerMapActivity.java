...
public class SellerMapActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        findViewById(R.id.activity_seller_map_back_btn).setOnClickListener(new View.OnClickListener() { // from class: com.texa.careapp.app.onboarding.SellerMapActivity$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.m292x9c987f0a(view);
            }
        });
        ...
        this.mNavigator.goTo(new SellerMapScreen(getCareApplication()));
    }

    /* JADX INFO: renamed from: lambda$onCreate$0$com-texa-careapp-app-onboarding-SellerMapActivity, reason: not valid java name */
    public /* synthetic */ void m292x9c987f0a(View view) {
        onBackPressed();
    }
