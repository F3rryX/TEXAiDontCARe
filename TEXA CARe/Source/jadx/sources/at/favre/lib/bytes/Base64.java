...
final class Base64 {
    ...
    static byte[] decode(CharSequence charSequence) {
        int i;
        char cCharAt;
        ...
        for (int i6 = 0; i6 < length; i6++) {
            ...
            if (cCharAt2 >= 'A' && cCharAt2 <= 'Z') {
                ...
                if (cCharAt2 != '\n' && cCharAt2 != '\r' && cCharAt2 != ' ' && cCharAt2 != '\t') {
                    throw new IllegalArgumentException("invalid character to decode: " + cCharAt2);
                }
            }
            i4 = (i4 << 6) | ((byte) i);
            i3++;
        ...
        return i5 == i2 ? bArr : Arrays.copyOfRange(bArr, 0, i5);
    }
    ...
    static byte[] encode(byte[] bArr, boolean z, boolean z2) {
        return encode(bArr, z ? URL_MAP : MAP, z2);
    }

    private static byte[] encode(byte[] bArr, byte[] bArr2, boolean z) {
        byte[] bArr3 = new byte[outLength(bArr.length, z)];
        ...
        if (length2 == 1) {
            ...
            int i13 = length + 1;
            bArr3[i10] = bArr2[((bArr[i13] & 255) >> 4) | i12];
            int i14 = i11 + 1;
            bArr3[i11] = bArr2[(bArr[i13] & 15) << 2];
            if (z) {
                bArr3[i14] = 61;
            }
        }
