...
import com.texa.carelib.webservices.internal.HttpMethod;
                ...
                if (num != null) {
                    ...
                    if (2 <= length && 7 >= length) {
                        if (Intrinsics.areEqual(Hpack.INSTANCE.getSTATIC_HEADER_TABLE()[length - 1].value, byteString)) {
                            length2 = length;
                        } else if (Intrinsics.areEqual(Hpack.INSTANCE.getSTATIC_HEADER_TABLE()[length].value, byteString)) {
                            length2 = length;
                            length++;
                        } else {
                            length2 = length;
