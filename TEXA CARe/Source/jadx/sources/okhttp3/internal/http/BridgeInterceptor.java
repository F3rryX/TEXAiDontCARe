...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (requestBodyBody != null) {
            ...
            if (contentType != null) {
                builderNewBuilder.header(TexaCareServiceBus.HEADER_CONTENT_TYPE, contentType.getMediaType());
            }
        ...
        if (request.header(TexaCareServiceBus.HEADER_USER_AGENT) == null) {
            builderNewBuilder.header(TexaCareServiceBus.HEADER_USER_AGENT, Util.userAgent);
        }
        ...
        if (z && StringsKt.equals("gzip", Response.header$default(responseProceed, "Content-Encoding", null, 2, null), true) && HttpHeaders.promisesBody(responseProceed) && (responseBodyBody = responseProceed.body()) != null) {
            ...
            builderRequest.body(new RealResponseBody(Response.header$default(responseProceed, TexaCareServiceBus.HEADER_CONTENT_TYPE, null, 2, null), -1L, Okio.buffer(gzipSource)));
        }
