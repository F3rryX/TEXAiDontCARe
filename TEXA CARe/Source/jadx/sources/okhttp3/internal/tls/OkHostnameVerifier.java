...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        ...
        String str2 = pattern;
        String str3 = str;
        if (!(str3 == null || str3.length() == 0) && !StringsKt.startsWith$default(str, Version.SEPARATOR, false, 2, (Object) null) && !StringsKt.endsWith$default(str, "..", false, 2, (Object) null)) {
            String str4 = str2;
            if (!(str4 == null || str4.length() == 0) && !StringsKt.startsWith$default(str2, Version.SEPARATOR, false, 2, (Object) null) && !StringsKt.endsWith$default(str2, "..", false, 2, (Object) null)) {
                if (!StringsKt.endsWith$default(str, Version.SEPARATOR, false, 2, (Object) null)) {
                    str = str + Version.SEPARATOR;
                }
                if (!StringsKt.endsWith$default(str2, Version.SEPARATOR, false, 2, (Object) null)) {
                    str2 = str2 + Version.SEPARATOR;
                }
                Locale locale = Locale.US;
                Intrinsics.checkNotNullExpressionValue(locale, "Locale.US");
