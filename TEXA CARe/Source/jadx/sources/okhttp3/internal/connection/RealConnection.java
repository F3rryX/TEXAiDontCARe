...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARN: Removed duplicated region for block: B:75:0x016e A[EDGE_INSN: B:75:0x016e->B:61:0x016e BREAK  A[LOOP:0: B:71:0x00a5->B:77:?], SYNTHETIC] */
    /*
    ...
    */
    ...
    private final Request createTunnelRequest() throws IOException {
        Request requestBuild = new Request.Builder().url(this.route.address().url()).method("CONNECT", null).header("Host", Util.toHostHeader(this.route.address().url(), true)).header("Proxy-Connection", "Keep-Alive").header(TexaCareServiceBus.HEADER_USER_AGENT, Util.userAgent).build();
    ...
    public String toString() {
        ...
        if (handshake == null || (objCipherSuite = handshake.cipherSuite()) == null) {
            objCipherSuite = SchedulerSupport.NONE;
        }
