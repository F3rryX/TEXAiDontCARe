...
public final class CacheInterceptor implements Interceptor {
    ...
    private final Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(Response.header$default(response, TexaCareServiceBus.HEADER_CONTENT_TYPE, null, 2, null), response.body().getContentLength(), Okio.buffer(source2))).build();
    }
    ...
    public static final class Companion {
        ...
        private final boolean isContentSpecificHeader(String fieldName) {
            return StringsKt.equals("Content-Length", fieldName, true) || StringsKt.equals("Content-Encoding", fieldName, true) || StringsKt.equals(TexaCareServiceBus.HEADER_CONTENT_TYPE, fieldName, true);
        }
    }
}
