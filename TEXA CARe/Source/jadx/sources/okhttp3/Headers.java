...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public final int m2312deprecated_size() {
        return size();
    }
    ...
    public static final class Companion {
        ...
        public final Headers m2314deprecated_of(String... namesAndValues) {
            Intrinsics.checkNotNullParameter(namesAndValues, "namesAndValues");
        ...
        public final Headers of(Map<String, String> toHeaders) {
            ...
            for (Map.Entry<String, String> entry : toHeaders.entrySet()) {
                ...
                companion.checkValue(string2, string);
                strArr[i] = string;
                strArr[i + 1] = string2;
                i += 2;
            }
        ...
        /* JADX INFO: renamed from: -deprecated_of, reason: not valid java name */
        public final Headers m2313deprecated_of(Map<String, String> headers) {
            Intrinsics.checkNotNullParameter(headers, "headers");
            return of(headers);
        }
