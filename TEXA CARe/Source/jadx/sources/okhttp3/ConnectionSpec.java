...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m2291deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m2293deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public static final class Builder {
        ...
        public final Builder cipherSuites(String... cipherSuites) throws CloneNotSupportedException {
            ...
            builder.cipherSuites = (String[]) objClone;
            return builder;
        }
        ...
        public final Builder tlsVersions(String... tlsVersions) throws CloneNotSupportedException {
            ...
            Objects.requireNonNull(objClone, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
            builder.tlsVersions = (String[]) objClone;
            return builder;
        }
