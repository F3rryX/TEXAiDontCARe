...
public final class HttpUrl {
    ...
    public final String m2320deprecated_encodedUsername() {
    ...
    public final String m2316deprecated_encodedPassword() {
    ...
    public static final class Builder {
        ...
        public final Builder query(String query) {
            ...
            Builder builder = this;
            builder.encodedQueryNamesAndValues = (query == null || (strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, query, 0, 0, HttpUrl.QUERY_ENCODE_SET, false, false, true, false, null, Commands.DPMT_NotifySlaveEvent, null)) == null) ? null : HttpUrl.INSTANCE.toQueryNamesAndValues$okhttp(strCanonicalize$okhttp$default);
            return builder;
        }
        ...
        public final Builder addQueryParameter(String name, String value) {
            ...
            list.add(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, name, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, Commands.DPMT_NotifySlaveEvent, null));
            List<String> list2 = builder.encodedQueryNamesAndValues;
            Intrinsics.checkNotNull(list2);
            list2.add(value != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, value, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, Commands.DPMT_NotifySlaveEvent, null) : null);
            return builder;
        }
        ...
        public final Builder removeAllQueryParameters(String name) {
            ...
            builder.removeAllCanonicalQueryParameters(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, name, 0, 0, HttpUrl.QUERY_COMPONENT_ENCODE_SET, false, false, true, false, null, Commands.DPMT_NotifySlaveEvent, null));
            return builder;
        }
        ...
        public final Builder reencodeForUri$okhttp() {
            ...
            builder.encodedFragment = str3 != null ? Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, str3, 0, 0, HttpUrl.FRAGMENT_ENCODE_SET_URI, true, true, false, true, null, 163, null) : null;
            return builder;
        }
        ...
        */
        ...
        public final Builder parse$okhttp(HttpUrl base, String input) {
                ...
                while (true) {
                    ...
                    if (bCharAt != 64) {
                        ...
                        if (!z3) {
                            ...
                            i3 = iIndexOfLastNonAsciiWhitespace$default;
                            String str4 = str3;
                            String strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, i5, iDelimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, Commands.GetSOSStatus, null);
                            if (z4) {
                            ...
                            if (iDelimiterOffset2 != iDelimiterOffset) {
                                this.encodedPassword = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, iDelimiterOffset2 + 1, iDelimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, Commands.GetSOSStatus, null);
                                z2 = true;
                            } else {
                                z2 = z3;
                            }
                            ...
                            str2 = str3;
                            i4 = iDelimiterOffset;
                            sb2.append(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, i5, iDelimiterOffset, " \"':;<=>@[]^`{}|/\\?#", true, false, false, false, null, Commands.GetSOSStatus, null));
            ...
            if (iDelimiterOffset3 < i7 && input.charAt(iDelimiterOffset3) == '?') {
                ...
                this.encodedQueryNamesAndValues = HttpUrl.INSTANCE.toQueryNamesAndValues$okhttp(Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, iDelimiterOffset3 + 1, iDelimiterOffset4, HttpUrl.QUERY_ENCODE_SET, true, false, true, false, null, Commands.DPM_GetStatus, null));
        ...
        private final void push(String input, int pos, int limit, boolean addTrailingSlash, boolean alreadyEncoded) {
            String strCanonicalize$okhttp$default = Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, input, pos, limit, HttpUrl.PATH_SEGMENT_ENCODE_SET, alreadyEncoded, false, false, false, null, Commands.GetSOSStatus, null);
        ...
        private final boolean isDot(String input) {
            return Intrinsics.areEqual(input, Version.SEPARATOR) || StringsKt.equals(input, "%2e", true);
        }
    ...
    public static final class Companion {
        ...
        public final HttpUrl m2334deprecated_get(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m2337deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m2336deprecated_get(URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m2335deprecated_get(URI uri) {
