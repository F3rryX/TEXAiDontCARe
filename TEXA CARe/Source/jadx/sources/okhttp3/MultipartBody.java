...
public final class MultipartBody extends RequestBody {
    ...
    public final String m2342deprecated_boundary() {
        return boundary();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* JADX INFO: renamed from: -deprecated_size, reason: not valid java name */
    public final int m2344deprecated_size() {
        return size();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "parts", imports = {}))
    /* JADX INFO: renamed from: -deprecated_parts, reason: not valid java name */
    public final List<Part> m2343deprecated_parts() {
        return this.parts;
    }
    ...
    public static final class Part {
        ...
        /* JADX INFO: compiled from: MultipartBody.kt */
        @Metadata(bv = {1, 0, 3}, d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001a\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\bH\u0007J\u0018\u0010\t\u001a\u00020\u00042\u0006\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\u000bH\u0007J\"\u0010\t\u001a\u00020\u00042\u0006\u0010\n\u001a\u00020\u000b2\b\u0010\r\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\u0007\u001a\u00020\bH\u0007¨\u0006\u000e"}, d2 = {"Lokhttp3/MultipartBody$Part$Companion;", "", "()V", "create", "Lokhttp3/MultipartBody$Part;", "headers", "Lokhttp3/Headers;", "body", "Lokhttp3/RequestBody;", "createFormData", AppMeasurementSdk.ConditionalUserProperty.NAME, "", "value", "filename", "okhttp"}, k = 1, mv = {1, 4, 0})
        public static final class Companion {
            ...
            public final Part create(Headers headers, RequestBody body) {
                ...
                if (!((headers != null ? headers.get(TexaCareServiceBus.HEADER_CONTENT_TYPE) : null) == null)) {
    ...
    public static final class Builder {
        ...
        public final Builder addPart(RequestBody body) {
            Intrinsics.checkNotNullParameter(body, "body");
            Builder builder = this;
            builder.addPart(Part.INSTANCE.create(body));
            return builder;
        }
        ...
        public final Builder addPart(Headers headers, RequestBody body) {
            Intrinsics.checkNotNullParameter(body, "body");
            Builder builder = this;
            builder.addPart(Part.INSTANCE.create(headers, body));
            return builder;
        }
        ...
        public final Builder addFormDataPart(String name, String value) {
            ...
            Intrinsics.checkNotNullParameter(value, "value");
            Builder builder = this;
            builder.addPart(Part.INSTANCE.createFormData(name, value));
            return builder;
        }
        ...
        public final Builder addFormDataPart(String name, String filename, RequestBody body) {
            ...
            Intrinsics.checkNotNullParameter(body, "body");
            Builder builder = this;
            builder.addPart(Part.INSTANCE.createFormData(name, filename, body));
            return builder;
        }
