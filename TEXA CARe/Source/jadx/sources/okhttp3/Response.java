...
public final class Response implements Closeable {
    ...
    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = Constants.GCM_EXTRA_MESSAGE, imports = {}))
    ...
    public final CacheControl m2382deprecated_cacheControl() {
        return cacheControl();
    }
    ...
    public static class Builder {
        ...
        public Builder sentRequestAtMillis(long sentRequestAtMillis) {
            Builder builder = this;
            builder.sentRequestAtMillis = sentRequestAtMillis;
            return builder;
        }

        public Builder receivedResponseAtMillis(long receivedResponseAtMillis) {
            Builder builder = this;
            builder.receivedResponseAtMillis = receivedResponseAtMillis;
            return builder;
        }
