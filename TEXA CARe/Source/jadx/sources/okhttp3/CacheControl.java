    ...
    public static final class Companion {
        ...
        */
        public final CacheControl parse(Headers headers) {
            ...
            while (i3 < size) {
                ...
                if (!StringsKt.equals(strName, "Cache-Control", z2)) {
                    ...
                    while (i2 < strValue.length()) {
                        ...
                        int iIndexOfElement2 = companion.indexOfElement(strValue, "=,;", i2);
                        String str4 = str2;
                        ...
                        if (iIndexOfElement2 != strValue.length()) {
                            ...
                            if (strValue.charAt(iIndexOfElement2) != ',' && strValue.charAt(iIndexOfElement2) != ';') {
                                ...
                                if (iIndexOfNonWhitespace < strValue.length() && strValue.charAt(iIndexOfNonWhitespace) == '\"') {
                                    ...
                                    Objects.requireNonNull(strValue, "null cannot be cast to non-null type java.lang.String");
                                    string = strValue.substring(i5, iIndexOf$default);
                                    Intrinsics.checkNotNullExpressionValue(string, "(this as java.lang.Strin…ing(startIndex, endIndex)");
                                    iIndexOfElement = iIndexOf$default + 1;
                                } else {
                                    iIndexOfElement = companion.indexOfElement(strValue, ",;", iIndexOfNonWhitespace);
                                    Objects.requireNonNull(strValue, "null cannot be cast to non-null type java.lang.String");
                            ...
                            if (!StringsKt.equals("no-cache", string2, true)) {
                                ...
                                if (StringsKt.equals("max-age", string2, true)) {
                                    ...
                                    z4 = z;
                                    if (StringsKt.equals("immutable", string2, true)) {
                                        z11 = true;
                                    }
                                }
                                z4 = z;
            ...
            return new CacheControl(z4, z5, nonNegativeInt, nonNegativeInt2, z6, z7, z8, nonNegativeInt3, nonNegativeInt4, z9, z10, z11, !z3 ? str2 : str3, null);
        }
