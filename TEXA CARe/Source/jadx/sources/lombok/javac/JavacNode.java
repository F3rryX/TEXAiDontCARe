...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/JavacNode.SCL.lombok */
public class JavacNode extends LombokNode<JavacAST, JavacNode, JCTree> {
    ...
    public boolean isStatic() {
        ...
        if (this.node instanceof JCTree.JCClassDecl) {
            ...
            long f = p.mods.flags;
            if ((512 & f) != 0 || (Http2Stream.EMIT_BUFFER_SIZE & f) != 0) {
                return true;
            }
        }
    ...
    public boolean isEnumMember() {
        ...
        return (getKind() != AST.Kind.FIELD || (mods = getModifiers()) == null || (Http2Stream.EMIT_BUFFER_SIZE & mods.flags) == 0) ? false : true;
    }

    @Override // lombok.core.LombokNode
    public boolean isEnumType() {
        JCTree.JCModifiers mods;
        return (getKind() != AST.Kind.TYPE || (mods = getModifiers()) == null || (Http2Stream.EMIT_BUFFER_SIZE & mods.flags) == 0) ? false : true;
    }
