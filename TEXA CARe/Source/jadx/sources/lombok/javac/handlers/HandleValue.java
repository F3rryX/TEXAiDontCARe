...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleValue.SCL.lombok */
@HandlerPriority(-512)
public class HandleValue extends JavacAnnotationHandler<Value> {
    ...
    public void handle(AnnotationValues<Value> annotation, JCTree.JCAnnotation ast, JavacNode annotationNode) {
        ...
        String staticConstructorName = ((Value) annotation.getInstance()).staticConstructor();
