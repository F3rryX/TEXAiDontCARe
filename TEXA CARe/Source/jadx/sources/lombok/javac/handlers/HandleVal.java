...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleVal.SCL.lombok */
@HandlerPriority(65536)
@ResolutionResetNeeded
public class HandleVal extends JavacASTAdapter {
    private static boolean eq(String typeTreeToString, String key) {
        return typeTreeToString.equals(key) || typeTreeToString.equals(new StringBuilder().append("lombok.").append(key).toString()) || typeTreeToString.equals(new StringBuilder().append("lombok.experimental.").append(key).toString());
    }
