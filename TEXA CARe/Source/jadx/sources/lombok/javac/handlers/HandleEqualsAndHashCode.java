...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleEqualsAndHashCode.SCL.lombok */
public class HandleEqualsAndHashCode extends JavacAnnotationHandler<EqualsAndHashCode> {
    ...
    public void generateMethods(JavacNode typeNode, JavacNode source, List<InclusionExclusionUtils.Included<JavacNode, EqualsAndHashCode.Include>> members, Boolean callSuper, boolean whineIfExists, HandlerUtil.FieldAccess fieldAccess, com.sun.tools.javac.util.List<JCTree.JCAnnotation> onParam) {
    ...
    public JCTree.JCMethodDecl createHashCode(JavacNode typeNode, List<InclusionExclusionUtils.Included<JavacNode, EqualsAndHashCode.Include>> members, boolean callSuper, HandlerUtil.FieldAccess fieldAccess, JCTree source) {
        ...
        statements.append(maker.VarDef(maker.Modifiers(isEmpty ? finalFlag : 0L), resultName, maker.TypeIdent(Javac.CTC_INT), jCMethodInvocationLiteral));
            ...
            if (fieldType instanceof JCTree.JCPrimitiveTypeTree) {
                switch (AnonymousClass1.$SwitchMap$javax$lang$model$type$TypeKind[((JCTree.JCPrimitiveTypeTree) fieldType).getPrimitiveTypeKind().ordinal()]) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Name dollarFieldName2 = memberNode.toName((isMethod ? "$$" : "$") + memberNode.getName());
                ...
                Name dollarFieldName3 = memberNode.toName((isMethod ? "$$" : "$") + memberNode.getName());
        ...
        return JavacHandlerUtil.recursiveSetGeneratedBy(maker.MethodDef(mods, typeNode.toName("hashCode"), jCPrimitiveTypeTreeTypeIdent, com.sun.tools.javac.util.List.nil(), com.sun.tools.javac.util.List.nil(), com.sun.tools.javac.util.List.nil(), body, null), source, typeNode.getContext());
    }

    /* JADX INFO: renamed from: lombok.javac.handlers.HandleEqualsAndHashCode$1, reason: invalid class name */
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleEqualsAndHashCode$1.SCL.lombok */
