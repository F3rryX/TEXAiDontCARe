...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleDelegate.SCL.lombok */
...
public class HandleDelegate extends JavacAnnotationHandler<Delegate> {
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleDelegate$CantMakeDelegates.SCL.lombok */
    public static class CantMakeDelegates extends Exception {
        Set<String> conflicted;
    }

    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleDelegate$DelegateReceiver.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleDelegate$DelegateRecursion.SCL.lombok */
        ...
        for (ExecutableElement executableElement : tsym.getEnclosedElements()) {
            ...
            if (executableElement.getKind() == ElementKind.METHOD && !executableElement.isStatic() && !executableElement.isConstructor()) {
                ...
                if (exElem.getModifiers().contains(Modifier.PUBLIC)) {
                    ...
                    if (banList.add(sig)) {
                        boolean isDeprecated = (executableElement.flags() & MockDataID.Parameter.VEHICLE_SPEED) != 0;
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleDelegate$MethodSig.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleDelegate$Unannotated.SCL.lombok */
