...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleLog.SCL.lombok */
public class HandleLog {
        ...
        switch (typeNode.getKind()) {
            case TYPE:
                ...
                if (logFieldName == null) {
                    logFieldName = Constants.SYNC_DISPATCHER_TAG_LOG;
                }
    ...
    private static boolean createField(LoggingFramework framework, JavacNode typeNode, JCTree.JCFieldAccess loggingType, JCTree source, String logFieldName, boolean useStatic, String loggerTopic) {
        ...
        if (!framework.passTypeName) {
            jCLiteralCreateFactoryParameter = null;
        ...
        JCTree.JCMethodInvocation factoryMethodCall = maker.Apply(List.nil(), factoryMethod, jCLiteralCreateFactoryParameter != null ? List.of(jCLiteralCreateFactoryParameter) : List.nil());
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleLog$HandleCommonsLog.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleLog$HandleJulLog.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleLog$HandleLog4jLog.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleLog$HandleLog4j2Log.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleLog$HandleSlf4jLog.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleLog$HandleXSlf4jLog.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleLog$HandleJBossLog.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleLog$HandleFloggerLog.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/handlers/HandleLog$LoggingFramework.SCL.lombok */
    enum LoggingFramework {
        ...
        LoggingFramework(Class cls, String loggerTypeName, String loggerFactoryName, boolean passTypeName) {
