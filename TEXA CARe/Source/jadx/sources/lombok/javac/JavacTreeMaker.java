...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/JavacTreeMaker.SCL.lombok */
public class JavacTreeMaker {
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/JavacTreeMaker$Case12.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/JavacTreeMaker$MethodId.SCL.lombok */
    private static class MethodId<J> {
        ...
        public String toString() {
            ...
            out.append(this.returnType.getName()).append(" ").append(this.owner.getName()).append(Version.SEPARATOR).append(this.name).append("(");
            boolean f = true;
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/JavacTreeMaker$SchroedingerType.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/JavacTreeMaker$TypeTag.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/JavacTreeMaker$TreeTag.SCL.lombok */
    ...
    public static <J> J invokeAny(Object obj, MethodId<J> methodId, Object... objArr) {
        Method fromCache = getFromCache(methodId);
        try {
            if (!((MethodId) methodId).returnType.isPrimitive()) {
                return (J) ((MethodId) methodId).returnType.cast(fromCache.invoke(obj, objArr));
            }
            J j = (J) fromCache.invoke(obj, objArr);
            if (!j.getClass().getSimpleName().toLowerCase().startsWith(((MethodId) methodId).returnType.getSimpleName())) {
                throw new ClassCastException(j.getClass() + " to " + ((MethodId) methodId).returnType);
            }
            return j;
        } catch (IllegalAccessException e) {
            throw Javac.sneakyThrow(e);
        } catch (IllegalArgumentException e2) {
            System.err.println(fromCache);
            throw Javac.sneakyThrow(e2);
    ...
    public JCTree.JCMethodDecl MethodDef(JCTree.JCModifiers mods, Name name, JCTree.JCExpression resType, List<JCTree.JCTypeParameter> typarams, JCTree.JCVariableDecl recvparam, List<JCTree.JCVariableDecl> params, List<JCTree.JCExpression> thrown, JCTree.JCBlock body, JCTree.JCExpression defaultValue) {
        return (JCTree.JCMethodDecl) invoke(MethodDefWithRecvParam, mods, name, resType, recvparam, typarams, params, thrown, body, defaultValue);
    }
    ...
    public JCTree.JCVariableDecl VarDef(JCTree.JCModifiers mods, Name name, JCTree.JCExpression vartype, JCTree.JCExpression init) {
        return (JCTree.JCVariableDecl) invoke(VarDef, mods, name, vartype, init);
    }
