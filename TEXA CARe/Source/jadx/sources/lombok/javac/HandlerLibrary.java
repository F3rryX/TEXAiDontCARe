...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/HandlerLibrary.SCL.lombok */
public class HandlerLibrary {
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/HandlerLibrary$VisitorContainer.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/javac/HandlerLibrary$AnnotationHandlerContainer.SCL.lombok */
    ...
    private static void loadAnnotationHandlers(HandlerLibrary lib, Trees trees) throws IOException {
        for (JavacAnnotationHandler handler : SpiLoadUtil.findServices(JavacAnnotationHandler.class, JavacAnnotationHandler.class.getClassLoader())) {
            ...
            String annotationClassName = ((AnnotationHandlerContainer) container).annotationClass.getName().replace("$", Version.SEPARATOR);
    ...
    public void handleAnnotation(JCTree.JCCompilationUnit unit, JavacNode node, JCTree.JCAnnotation annotation, long priority) {
        ...
        Iterator<AnnotationHandlerContainer<?>> it = containers.iterator();
        while (it.hasNext()) {
            AnnotationHandlerContainer<?> container = it.next();
            try {
                if (container.getPriority() == priority && (checkAndSetHandled(annotation) || container.isEvenIfAlreadyHandled())) {
