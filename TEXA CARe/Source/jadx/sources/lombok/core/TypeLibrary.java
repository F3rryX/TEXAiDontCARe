...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/core/TypeLibrary.SCL.lombok */
public class TypeLibrary {
    ...
    public void addType(String fullyQualifiedTypeName) {
        String dotBased = fullyQualifiedTypeName.replace("$", com.texa.carelib.core.utils.Version.SEPARATOR);
        if (this.locked) {
        ...
        this.unqualifiedToQualifiedMap.put(unqualified.replace("$", com.texa.carelib.core.utils.Version.SEPARATOR), dotBased);
        ...
        while (true) {
            ...
            if (idx2 != -1) {
                ...
                this.unqualifiedToQualifiedMap.put(unq.replace("$", com.texa.carelib.core.utils.Version.SEPARATOR), dotBased);
