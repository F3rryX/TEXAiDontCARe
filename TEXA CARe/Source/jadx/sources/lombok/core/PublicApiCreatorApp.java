...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/core/PublicApiCreatorApp.SCL.lombok */
public class PublicApiCreatorApp extends LombokApp {
    ...
    public int runApp(List<String> rawArgs) throws Exception {
        String loc = com.texa.carelib.core.utils.Version.SEPARATOR;
        switch (rawArgs.size()) {
            case 0:
                break;
            case 1:
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/core/PublicApiCreatorApp$Fail.SCL.lombok */
