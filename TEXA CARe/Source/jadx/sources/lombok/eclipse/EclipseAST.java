...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/EclipseAST.SCL.lombok */
public class EclipseAST extends AST<EclipseAST, EclipseNode, ASTNode> {
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/EclipseAST$EclipseWorkspaceBasedFileResolver.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/EclipseAST$ParseProblem.SCL.lombok */
    class ParseProblem {
    ...
    public static Annotation[] getTopLevelTypeReferenceAnnotations(TypeReference tr) {
        ...
        try {
            Annotation[][] annss = (Annotation[][]) m.invoke(tr, new Object[0]);
            if (annss != null) {
                return annss[0];
            }
        ...
        try {
            ...
            Annotation[][] annss2 = (Annotation[][]) f.get(tr);
            return annss2[annss2.length - 1];
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/EclipseAST$EcjReflectionCheck.SCL.lombok */
