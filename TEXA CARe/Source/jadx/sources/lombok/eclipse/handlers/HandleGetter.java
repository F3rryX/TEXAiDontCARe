...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/HandleGetter.SCL.lombok */
public class HandleGetter extends EclipseAnnotationHandler<Getter> {
    ...
    public MethodDeclaration createGetter(TypeDeclaration parent, EclipseNode fieldNode, String name, int modifier, ASTNode source, boolean lazy, List<Annotation> onMethod) {
        ...
        method.annotations = EclipseHandlerUtil.copyAnnotations(source, new Annotation[]{(Annotation[]) onMethod.toArray(new Annotation[0]), EclipseHandlerUtil.findCopyableAnnotations(fieldNode), findDelegatesAndMarkAsHandled(fieldNode), deprecated});
