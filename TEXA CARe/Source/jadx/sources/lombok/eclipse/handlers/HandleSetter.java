...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/HandleSetter.SCL.lombok */
public class HandleSetter extends EclipseAnnotationHandler<Setter> {
    ...
    public void createSetterForField(AccessLevel level, EclipseNode fieldNode, EclipseNode sourceNode, boolean whineIfExists, List<Annotation> onMethod, List<Annotation> onParam) {
        ...
        MethodDeclaration method = createSetter(fieldNode.up().get(), false, fieldNode, setterName, null, shouldReturnThis, modifier, sourceNode, onMethod, onParam);
    ...
    /* JADX WARN: Type inference failed for: r2v26, types: [org.eclipse.jdt.internal.compiler.ast.Annotation[], org.eclipse.jdt.internal.compiler.ast.Annotation[][]] */
    ...
    static MethodDeclaration createSetter(TypeDeclaration parent, boolean deprecate, EclipseNode fieldNode, String name, char[] booleanFieldToSet, TypeReference returnType, Statement returnStatement, int modifier, EclipseNode sourceNode, List<Annotation> onMethod, List<Annotation> onParam) {
        ...
        method.annotations = EclipseHandlerUtil.copyAnnotations(source, new Annotation[]{(Annotation[]) onMethod.toArray(new Annotation[0]), deprecated});
        ...
        Assignment assignment = new Assignment(fieldRef, new SingleNameReference(field.name, p), (int) p);
