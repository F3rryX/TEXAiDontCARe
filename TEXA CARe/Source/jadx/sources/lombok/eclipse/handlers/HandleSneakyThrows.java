...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/HandleSneakyThrows.SCL.lombok */
@DeferUntilPostDiet
...
public class HandleSneakyThrows extends EclipseAnnotationHandler<SneakyThrows> {
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/HandleSneakyThrows$DeclaredException.SCL.lombok */
    ...
    public Statement buildTryCatchBlock(Statement[] contents, DeclaredException exception, ASTNode source, AbstractMethodDeclaration method) {
        ...
        long methodPosEnd = (((long) methodEnd) << 32) | (((long) methodEnd) & BodyPartID.bodyIdMax);
