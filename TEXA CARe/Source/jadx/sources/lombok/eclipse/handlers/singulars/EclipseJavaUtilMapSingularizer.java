...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/singulars/EclipseJavaUtilMapSingularizer.SCL.lombok */
public class EclipseJavaUtilMapSingularizer extends EclipseJavaUtilSingularizer {
    ...
    public List<char[]> listFieldsToBeGenerated(EclipseSingularsRecipes.SingularData data, EclipseNode builderType) {
        ...
        k[len] = Typography.dollar;
        k[len + 1] = 'k';
        k[len + 2] = 'e';
        k[len + 3] = 'y';
        v[len] = Typography.dollar;
        v[len + 1] = 'v';
        v[len + 2] = 'a';
        v[len + 3] = 'l';
        v[len + 4] = 'u';
    ...
    public void generateMethods(EclipseSingularsRecipes.SingularData data, boolean deprecate, EclipseNode builderType, boolean fluent, EclipseSingularsRecipes.TypeReferenceMaker returnTypeMaker, EclipseSingularsRecipes.StatementMaker returnStatementMaker) {
        if (useGuavaInstead(builderType)) {
            this.guavaMapSingularizer.generateMethods(data, deprecate, builderType, fluent, returnTypeMaker, returnStatementMaker);
            return;
        }
