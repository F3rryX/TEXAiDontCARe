...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/singulars/EclipseJavaUtilSingularizer.SCL.lombok */
abstract class EclipseJavaUtilSingularizer extends EclipseSingularsRecipes.EclipseSingularizer {
    protected static final char[][] JAVA_UTIL_ARRAYLIST = {new char[]{'j', 'a', 'v', 'a'}, new char[]{'u', 't', 'i', 'l'}, new char[]{'A', 'r', 'r', 'a', 'y', Matrix.MATRIX_TYPE_RANDOM_LT, 'i', 's', 't'}};
    protected static final char[][] JAVA_UTIL_LIST = {new char[]{'j', 'a', 'v', 'a'}, new char[]{'u', 't', 'i', 'l'}, new char[]{Matrix.MATRIX_TYPE_RANDOM_LT, 'i', 's', 't'}};
    ...
    protected List<Statement> createJavaUtilSetMapInitialCapacitySwitchStatements(EclipseSingularsRecipes.SingularData data, EclipseNode builderType, boolean mapMode, String emptyCollectionMethod, String singletonCollectionMethod, String targetType, String builderVariable) {
        ...
        if (emptyCollectionMethod != null) {
            switchContents.add(new CaseStatement(EclipseHandlerUtil.makeIntLiteral(new char[]{'0'}, null), 0, 0));
        ...
        if (singletonCollectionMethod != null) {
            switchContents.add(new CaseStatement(EclipseHandlerUtil.makeIntLiteral(new char[]{'1'}, null), 0, 0));
        ...
        switchContents.add(new CaseStatement((Expression) null, 0, 0));
