...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/HandleConstructor.SCL.lombok */
public class HandleConstructor {
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/HandleConstructor$SkipIfConstructorExists.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/HandleConstructor$HandleNoArgsConstructor.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/HandleConstructor$HandleRequiredArgsConstructor.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/HandleConstructor$HandleAllArgsConstructor.SCL.lombok */
    ...
    public static ConstructorDeclaration createConstructor(AccessLevel level, EclipseNode type, Collection<EclipseNode> fieldsToParam, boolean forceDefaults, EclipseNode sourceNode, List<Annotation> onConstructor) {
        ...
        for (EclipseNode fieldNode : fieldsToParam) {
            ...
            if (EclipseHandlerUtil.hasNonNullAnnotations(fieldNode) && (nullCheck = EclipseHandlerUtil.generateNullCheck(parameter, sourceNode)) != null) {
