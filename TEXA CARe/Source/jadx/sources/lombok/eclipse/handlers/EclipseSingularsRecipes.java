...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/EclipseSingularsRecipes.SCL.lombok */
public class EclipseSingularsRecipes {
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/EclipseSingularsRecipes$StatementMaker.SCL.lombok */
    public interface StatementMaker {
        /* JADX INFO: renamed from: make */
        Statement mo2168make();
    }

    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/EclipseSingularsRecipes$TypeReferenceMaker.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/EclipseSingularsRecipes$SingularData.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/handlers/EclipseSingularsRecipes$EclipseSingularizer.SCL.lombok */
    public static abstract class EclipseSingularizer {
        ...
        public abstract void generateMethods(SingularData singularData, boolean z, EclipseNode eclipseNode, boolean z2, TypeReferenceMaker typeReferenceMaker, StatementMaker statementMaker);
        ...
        public void generateMethods(SingularData data, boolean deprecate, final EclipseNode builderType, boolean fluent, final boolean chain) {
            TypeReferenceMaker returnTypeMaker = new TypeReferenceMaker() { // from class: lombok.eclipse.handlers.EclipseSingularsRecipes.EclipseSingularizer.1
                ...
                public TypeReference make() {
                    return chain ? EclipseHandlerUtil.cloneSelfType(builderType) : TypeReference.baseTypeReference(6, 0);
                }
            };
