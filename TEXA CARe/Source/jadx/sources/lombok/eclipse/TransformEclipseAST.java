...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/TransformEclipseAST.SCL.lombok */
public class TransformEclipseAST {
    ...
    public static void transform(Parser parser, CompilationUnitDeclaration ast) {
        if (disableLombok || Symbols.hasSymbol("lombok.disable") || Boolean.TRUE.equals(LombokConfiguration.read(ConfigurationKeys.LOMBOK_DISABLE, EclipseAST.getAbsoluteFileLocation(ast)))) {
            return;
        }
        try {
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/TransformEclipseAST$AnnotationVisitor.SCL.lombok */
    private static class AnnotationVisitor extends EclipseASTAdapter {
        private final long priority;
        private long nextPriority = LongCompanionObject.MAX_VALUE;
