...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/agent/PatchDelegate.SCL.lombok */
public class PatchDelegate {
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/agent/PatchDelegate$CantMakeDelegates.SCL.lombok */
    public static class CantMakeDelegates extends Exception {
        public Set<String> conflicted;
    }

    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/agent/PatchDelegate$ClassScopeEntry.SCL.lombok */
    ...
    public static boolean handleDelegateForType(ClassScope scope) {
        if (TransformEclipseAST.disableLombok || !hasDelegateMarkedFieldsOrMethods(scope.referenceContext)) {
            return false;
        }
            ...
            for (FieldDeclaration field : decl.fields) {
                if (field.annotations != null) {
                    ...
                    while (true) {
                        ...
                        if (isDelegate(ann, decl) && !EclipseAugments.Annotation_applied.getAndSet(ann, true).booleanValue()) {
    ...
    private static boolean isDelegate(Annotation ann, TypeDeclaration decl) {
        TypeBinding tb;
        if (ann.type == null || (tb = ann.type.resolveType(decl.initializerScope)) == null) {
            return false;
        }
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/agent/PatchDelegate$TypeVarFinder.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/agent/PatchDelegate$EclipseTypeBindingScanner.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/agent/PatchDelegate$Reflection.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/agent/PatchDelegate$DelegateRecursion.SCL.lombok */
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/agent/PatchDelegate$BindingTuple.SCL.lombok */
    ...
    private static String typeBindingToSignature(TypeBinding binding) {
        ...
        if (binding2 instanceof ReferenceBinding) {
            ...
            return pkg.isEmpty() ? qsn : String.valueOf(pkg) + Version.SEPARATOR + qsn;
        }
        if (binding2 instanceof ArrayBinding) {
            ...
            for (int i = 0; i < binding2.dimensions(); i++) {
                out.append(HttpUrl.PATH_SEGMENT_ENCODE_SET_URI);
            }
            return out.toString();
        }
        return "";
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/agent/PatchDelegate$DelegateReceiver.SCL.lombok */
