...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/EclipseASTVisitor.SCL.lombok */
public interface EclipseASTVisitor {
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/EclipseASTVisitor$Printer.SCL.lombok */
    public static class Printer implements EclipseASTVisitor {
        ...
        private String str(TypeReference type) {
            ...
            boolean first = true;
            for (char[] d : c) {
                sb.append(first ? "" : Version.SEPARATOR).append(new String(d));
                first = false;
            }
            return sb.toString();
        }
