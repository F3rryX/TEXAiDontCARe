...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/eclipse/Eclipse.SCL.lombok */
public class Eclipse {
    ...
    public static long pos(ASTNode node) {
        return (((long) node.sourceStart) << 32) | (((long) node.sourceEnd) & BodyPartID.bodyIdMax);
    }

    public static long[] poss(ASTNode node, int repeat) {
        long p = (((long) node.sourceStart) << 32) | (((long) node.sourceEnd) & BodyPartID.bodyIdMax);
