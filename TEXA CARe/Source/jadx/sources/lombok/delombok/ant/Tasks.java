...
/* JADX INFO: compiled from: DelombokTask.java */
...
class Tasks {
    ...
    public static class Delombok extends Task {
        ...
        public void execute() throws BuildException {
            ...
            try {
                Object objNewInstance = shadowLoadClass("lombok.delombok.ant.DelombokTaskImpl").newInstance();
                for (Field field : getClass().getDeclaredFields()) {
                    if (!field.isSynthetic() && !Modifier.isStatic(field.getModifiers())) {
                        Field declaredField = objNewInstance.getClass().getDeclaredField(field.getName());
                        ...
                        if (field.getName().equals("formatOptions")) {
                            ...
                            declaredField.set(objNewInstance, arrayList);
                        } else {
                            declaredField.set(objNewInstance, field.get(this));
                        }
                    }
                }
                objNewInstance.getClass().getMethod("execute", Location.class).invoke(objNewInstance, location);
            } catch (Exception e) {
                e = e;
