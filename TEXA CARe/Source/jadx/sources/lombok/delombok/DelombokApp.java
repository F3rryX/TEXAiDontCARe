...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/delombok/DelombokApp.SCL.lombok */
public class DelombokApp extends LombokApp {
    ...
    public static Class<?> loadDelombok(List<String> args) throws Exception {
        ...
        if (toolsJar == null) {
            ...
            for (String arg : args) {
                ...
                if (arg.contains(" ")) {
                    sb.append(Typography.quote).append(arg).append(Typography.quote);
                } else {
                    sb.append(arg);
                }
            }
        ...
        ClassLoader loader = new ClassLoader(DelombokApp.class.getClassLoader()) { // from class: lombok.delombok.DelombokApp.1
            ...
            protected synchronized Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
                String binName = name.replace(Version.SEPARATOR, "/");
                String rawName = binName + ".class";
                String altName = binName + ".SCL.lombok";
            ...
            public Enumeration<URL> getResources(final String name) throws IOException {
                ...
                return entry == null ? super.getResources(name) : new Enumeration<URL>() { // from class: lombok.delombok.DelombokApp.1.1
    ...
    private static File findToolsJarViaProperties() {
        File home = new File(System.getProperty("java.home", Version.SEPARATOR));
