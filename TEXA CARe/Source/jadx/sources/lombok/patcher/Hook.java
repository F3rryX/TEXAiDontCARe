...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/patcher/Hook.SCL.lombok */
public class Hook {
    ...
    static {
        ...
        m.put("int", "I");
        m.put("long", "J");
        m.put("short", ExifInterface.LATITUDE_SOUTH);
        m.put("byte", "B");
        m.put("char", "C");
        m.put("double", "D");
        m.put("float", "F");
    ...
    public static String toSpec(String type) {
        StringBuilder out = new StringBuilder();
        while (type.endsWith(HttpUrl.PATH_SEGMENT_ENCODE_SET_URI)) {
