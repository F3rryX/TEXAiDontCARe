...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/patcher/MethodTarget.SCL.lombok */
public final class MethodTarget implements TargetMatcher {
    ...
    private MethodTarget(String classSpec, String methodName, boolean hasDescription, String returnSpec, String[] parameterSpecs) {
        ...
        if (methodName.contains("[") || methodName.contains(com.texa.carelib.core.utils.Version.SEPARATOR)) {
    ...
    public static boolean typeMatches(String type, String pattern) {
        return type.replace("/", com.texa.carelib.core.utils.Version.SEPARATOR).equals(pattern);
    }
