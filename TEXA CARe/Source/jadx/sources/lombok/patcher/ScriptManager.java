...
/* JADX INFO: loaded from: com.texa.care.apk:lombok/patcher/ScriptManager.SCL.lombok */
public class ScriptManager {
    ...
    /* JADX INFO: loaded from: com.texa.care.apk:lombok/patcher/ScriptManager$OurClassFileTransformer.SCL.lombok */
    private class OurClassFileTransformer implements ClassFileTransformer {
        ...
        public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws IllegalClassFormatException {
            byte[] transformed;
            if (className == null || !ScriptManager.this.filter.shouldTransform(loader, className, classBeingRedefined, protectionDomain, classfileBuffer)) {
                return null;
            }
