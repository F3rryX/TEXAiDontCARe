...
public final class UStringsKt {
    ...
    public static final String m2043toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2045toStringolVBNx4(short s, int i) {
    ...
    public static final String m2044toStringV7xB4Y4(int i, int i2) {
        String string = Long.toString(((long) i) & BodyPartID.bodyIdMax, CharsKt.checkRadix(i2));
    ...
    public static final String m2042toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String toUByteOrNull, int i) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m881constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m807boximpl(UByte.m813constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int i) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m881constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m1043boximpl(UShort.m1049constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int i) {
        ...
        int iM881constructorimpl = UInt.m881constructorimpl(i);
        int iM1110uintDivideJ1ME1BU = 119304647;
        while (i3 < length) {
            int iDigitOf = CharsKt.digitOf(toUIntOrNull.charAt(i3), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (UnsignedKt.uintCompare(i2, iM1110uintDivideJ1ME1BU) > 0) {
                if (iM1110uintDivideJ1ME1BU == 119304647) {
                    iM1110uintDivideJ1ME1BU = UnsignedKt.m1110uintDivideJ1ME1BU(-1, iM881constructorimpl);
                    if (UnsignedKt.uintCompare(i2, iM1110uintDivideJ1ME1BU) > 0) {
                    }
                }
                return null;
            }
            int iM881constructorimpl2 = UInt.m881constructorimpl(i2 * iM881constructorimpl);
            int iM881constructorimpl3 = UInt.m881constructorimpl(UInt.m881constructorimpl(iDigitOf) + iM881constructorimpl2);
            if (UnsignedKt.uintCompare(iM881constructorimpl3, iM881constructorimpl2) < 0) {
                return null;
            }
            i3++;
            i2 = iM881constructorimpl3;
        }
        return UInt.m875boximpl(i2);
    }
    ...
    public static final ULong toULongOrNull(String toULongOrNull, int i) {
        ...
        long jM951constructorimpl = ULong.m951constructorimpl(i);
        long j2 = 0;
        long jM1112ulongDivideeb3DHEI = 512409557603043100L;
        while (i2 < length) {
            int iDigitOf = CharsKt.digitOf(toULongOrNull.charAt(i2), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (UnsignedKt.ulongCompare(j2, jM1112ulongDivideeb3DHEI) > 0) {
                if (jM1112ulongDivideeb3DHEI == 512409557603043100L) {
                    jM1112ulongDivideeb3DHEI = UnsignedKt.m1112ulongDivideeb3DHEI(j, jM951constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, jM1112ulongDivideeb3DHEI) > 0) {
                    }
                }
                return null;
            }
            long jM951constructorimpl2 = ULong.m951constructorimpl(j2 * jM951constructorimpl);
            long jM951constructorimpl3 = ULong.m951constructorimpl(ULong.m951constructorimpl(((long) UInt.m881constructorimpl(iDigitOf)) & BodyPartID.bodyIdMax) + jM951constructorimpl2);
            if (UnsignedKt.ulongCompare(jM951constructorimpl3, jM951constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = jM951constructorimpl3;
            j = -1;
        }
        return ULong.m945boximpl(j2);
    }
}
