...
public final class DurationConversionsJDK8Kt {
    private static final double toKotlinDuration(Duration duration) {
        return kotlin.time.Duration.m2077plusLRDsOJo(DurationKt.getSeconds(duration.getSeconds()), DurationKt.getNanoseconds(duration.getNano()));
    }

    /* JADX INFO: renamed from: toJavaDuration-LRDsOJo, reason: not valid java name */
    private static final Duration m2108toJavaDurationLRDsOJo(double d) {
        Duration durationOfSeconds = Duration.ofSeconds((long) kotlin.time.Duration.m2067getInSecondsimpl(d), kotlin.time.Duration.m2069getNanosecondsComponentimpl(d));
