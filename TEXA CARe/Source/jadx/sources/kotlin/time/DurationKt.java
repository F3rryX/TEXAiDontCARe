...
public final class DurationKt {
    ...
    private static final double m2100timesmvk6XK0(int i, double d) {
        return Duration.m2080timesUwyO8pc(d, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final double m2099timeskIfJnKk(double d, double d2) {
        return Duration.m2079timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        return Duration.m2053constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
