...
public final class MeasureTimeKt {
    public static final double measureTime(Function0<Unit> block) {
        ...
        block.invoke();
        return timeMarkMarkNow.mo2046elapsedNowUwyO8pc();
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.INSTANCE.markNow().mo2046elapsedNowUwyO8pc(), null);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(TimeSource measureTimedValue, Function0<? extends T> block) {
        ...
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), measureTimedValue.markNow().mo2046elapsedNowUwyO8pc(), null);
    }
}
