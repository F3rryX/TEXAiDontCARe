...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m2104copyRFiDyg4$default(TimedValue timedValue, Object obj, double d, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m2106copyRFiDyg4(obj, d);
    }
    ...
    public final TimedValue<T> m2106copyRFiDyg4(T value, double duration) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m2091toStringimpl(this.duration) + ")";
    }
    ...
    public final double m2107getDurationUwyO8pc() {
        return this.duration;
    }
