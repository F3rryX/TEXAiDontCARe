...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double mo2046elapsedNowUwyO8pc() {
        return Duration.m2076minusLRDsOJo(this.mark.mo2046elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo2047plusLRDsOJo(double duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2077plusLRDsOJo(this.adjustment, duration), null);
    }
}
