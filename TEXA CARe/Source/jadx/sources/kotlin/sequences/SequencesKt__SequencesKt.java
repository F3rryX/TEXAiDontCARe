...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C00561<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        C00561(Sequence sequence, Function0 function0, Continuation continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            ...
            C00561 c00561 = new C00561(this.$this_ifEmpty, this.$defaultValue, completion);
            c00561.p$ = (SequenceScope) obj;
            return c00561;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
            return ((C00561) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> ifEmpty, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C00561(ifEmpty, defaultValue, null));
    }
    ...
    static final class C00571<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00571(Sequence sequence, Random random, Continuation continuation) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            Intrinsics.checkNotNullParameter(completion, "completion");
            C00571 c00571 = new C00571(this.$this_shuffled, this.$random, completion);
            c00571.p$ = (SequenceScope) obj;
            return c00571;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
            return ((C00571) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> shuffled, Random random) {
        ...
        return SequencesKt.sequence(new C00571(shuffled, random, null));
    }
    ...
    static final class C00521<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00521(Sequence sequence, Function2 function2, Function1 function1, Continuation continuation) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            Intrinsics.checkNotNullParameter(completion, "completion");
            C00521 c00521 = new C00521(this.$source, this.$transform, this.$iterator, completion);
            c00521.p$ = (SequenceScope) obj;
            return c00521;
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
            return ((C00521) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            while (it.hasNext()) {
                ...
                Iterator it2 = (Iterator) this.$iterator.invoke(objInvoke);
                this.L$0 = sequenceScope;
                this.I$0 = i4;
                this.L$1 = next;
                this.L$2 = it;
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        return SequencesKt.sequence(new C00521(source, transform, iterator, null));
    }
