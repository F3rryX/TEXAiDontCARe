...
public final class UnsignedKt {
    ...
    public static final int m1110uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m881constructorimpl((int) ((((long) i) & BodyPartID.bodyIdMax) / (((long) i2) & BodyPartID.bodyIdMax)));
    }

    /* JADX INFO: renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m1111uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m881constructorimpl((int) ((((long) i) & BodyPartID.bodyIdMax) % (((long) i2) & BodyPartID.bodyIdMax)));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m1112ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? ULong.m951constructorimpl(0L) : ULong.m951constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m951constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m951constructorimpl(j3 + ((long) (ulongCompare(ULong.m951constructorimpl(j - (j3 * j2)), ULong.m951constructorimpl(j2)) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m1113ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return ulongCompare(j, j2) < 0 ? j : ULong.m951constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m951constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (ulongCompare(ULong.m951constructorimpl(j3), ULong.m951constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m951constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= d2) {
            return UInt.m881constructorimpl((int) d);
        }
        return UInt.m881constructorimpl(UInt.m881constructorimpl((int) (d - d2)) + UInt.m881constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < LongCompanionObject.MAX_VALUE) {
            return ULong.m951constructorimpl((long) d);
        }
        return ULong.m951constructorimpl(ULong.m951constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
