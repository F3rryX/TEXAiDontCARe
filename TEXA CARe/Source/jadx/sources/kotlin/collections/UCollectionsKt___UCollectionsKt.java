...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> toUByteArray) {
        ...
        byte[] bArrM856constructorimpl = UByteArray.m856constructorimpl(toUByteArray.size());
        Iterator<UByte> it = toUByteArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UByteArray.m867setVurrAj0(bArrM856constructorimpl, i, it.next().getData());
            i++;
        }
        return bArrM856constructorimpl;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> toUIntArray) {
        ...
        int[] iArrM926constructorimpl = UIntArray.m926constructorimpl(toUIntArray.size());
        Iterator<UInt> it = toUIntArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UIntArray.m937setVXSXFK8(iArrM926constructorimpl, i, it.next().getData());
            i++;
        }
        return iArrM926constructorimpl;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> toULongArray) {
        ...
        long[] jArrM996constructorimpl = ULongArray.m996constructorimpl(toULongArray.size());
        Iterator<ULong> it = toULongArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            ULongArray.m1007setk8EXiF4(jArrM996constructorimpl, i, it.next().getData());
            i++;
        }
        return jArrM996constructorimpl;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> toUShortArray) {
        ...
        short[] sArrM1092constructorimpl = UShortArray.m1092constructorimpl(toUShortArray.size());
        Iterator<UShort> it = toUShortArray.iterator();
        int i = 0;
        while (it.hasNext()) {
            UShortArray.m1103set01HTLdE(sArrM1092constructorimpl, i, it.next().getData());
            i++;
        }
        return sArrM1092constructorimpl;
    }

    public static final int sumOfUInt(Iterable<UInt> sum) {
        Intrinsics.checkNotNullParameter(sum, "$this$sum");
        Iterator<UInt> it = sum.iterator();
        int iM881constructorimpl = 0;
        while (it.hasNext()) {
            iM881constructorimpl = UInt.m881constructorimpl(iM881constructorimpl + it.next().getData());
        }
        return iM881constructorimpl;
    }

    public static final long sumOfULong(Iterable<ULong> sum) {
        Intrinsics.checkNotNullParameter(sum, "$this$sum");
        Iterator<ULong> it = sum.iterator();
        long jM951constructorimpl = 0;
        while (it.hasNext()) {
            jM951constructorimpl = ULong.m951constructorimpl(jM951constructorimpl + it.next().getData());
        }
        return jM951constructorimpl;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> sum) {
        ...
        int iM881constructorimpl = 0;
        while (it.hasNext()) {
            iM881constructorimpl = UInt.m881constructorimpl(iM881constructorimpl + UInt.m881constructorimpl(it.next().getData() & 255));
        }
        return iM881constructorimpl;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> sum) {
        ...
        int iM881constructorimpl = 0;
        while (it.hasNext()) {
            iM881constructorimpl = UInt.m881constructorimpl(iM881constructorimpl + UInt.m881constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return iM881constructorimpl;
    }
}
