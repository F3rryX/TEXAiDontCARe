...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static final /* synthetic */ UIntArray m925boximpl(int[] v) {
        Intrinsics.checkNotNullParameter(v, "v");
        return new UIntArray(v);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int[] m927constructorimpl(int[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m930equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual(iArr, ((UIntArray) obj).getStorage());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m931equalsimpl0(int[] iArr, int[] iArr2) {
    ...
    public static int m934hashCodeimpl(int[] iArr) {
        if (iArr != null) {
    ...
    public static String m938toStringimpl(int[] iArr) {
    ...
    public boolean m939addWZ4Q5Ns(int i) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean m940containsWZ4Q5Ns(int i) {
        return m928containsWZ4Q5Ns(this.storage, i);
    }
    ...
    public boolean equals(Object other) {
        return m930equalsimpl(this.storage, other);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m940containsWZ4Q5Ns(((UInt) obj).getData());
        }
        return false;
    }
    ...
    public static int[] m926constructorimpl(int i) {
        return m927constructorimpl(new int[i]);
    }

    /* JADX INFO: renamed from: get-pVg5ArA, reason: not valid java name */
    public static final int m932getpVg5ArA(int[] iArr, int i) {
        return UInt.m881constructorimpl(iArr[i]);
    }

    /* JADX INFO: renamed from: set-VXSXFK8, reason: not valid java name */
    public static final void m937setVXSXFK8(int[] iArr, int i, int i2) {
        iArr[i] = i2;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m933getSizeimpl(int[] iArr) {
        return iArr.length;
    }

    /* JADX INFO: renamed from: iterator-impl, reason: not valid java name */
    public static UIntIterator m936iteratorimpl(int[] iArr) {
    ...
    private static final class Iterator extends UIntIterator {
        ...
        public int mo942nextUIntpVg5ArA() {
            int i = this.index;
            int[] iArr = this.array;
            if (i >= iArr.length) {
    ...
    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public static boolean m928containsWZ4Q5Ns(int[] iArr, int i) {
        return ArraysKt.contains(iArr, i);
    }

    /* JADX INFO: renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m929containsAllimpl(int[] iArr, Collection<UInt> elements) {
    ...
    public static boolean m935isEmptyimpl(int[] iArr) {
