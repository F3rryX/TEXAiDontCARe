...
public final class RealBufferedSourceKt {
    ...
    public static final String commonReadUtf8LineStrict(buffer commonReadUtf8LineStrict, long j) throws EOFException {
        ...
        if (j2 < LongCompanionObject.MAX_VALUE && commonReadUtf8LineStrict.request(j2) && commonReadUtf8LineStrict.bufferField.getByte(j2 - 1) == ((byte) 13) && commonReadUtf8LineStrict.request(1 + j2) && commonReadUtf8LineStrict.bufferField.getByte(j2) == b) {
