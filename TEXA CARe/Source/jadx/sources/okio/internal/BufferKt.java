...
public final class BufferKt {
    ...
    */
    ...
    public static final long commonReadLong(Buffer commonReadLong) throws EOFException {
        ...
        int i2 = segment.limit;
        if (i2 - i < 8) {
            return ((((long) commonReadLong.readInt()) & BodyPartID.bodyIdMax) << 32) | (BodyPartID.bodyIdMax & ((long) commonReadLong.readInt()));
        }
        byte[] bArr = segment.data;
        int i3 = i + 1;
    ...
    /* JADX WARN: Removed duplicated region for block: B:51:0x00cb A[EDGE_INSN: B:51:0x00cb->B:41:0x00cb BREAK  A[LOOP:0: B:5:0x0016->B:53:?], SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    */
            ...
            if (cCharAt < 128) {
                ...
                if (cCharAt < 2048) {
                    ...
                    if (cCharAt > 56319 || 56320 > cCharAt3 || 57343 < cCharAt3) {
                        ...
                        segmentWritableSegment$okio4.data[segmentWritableSegment$okio4.limit] = (byte) ((i6 >> 18) | Commands.GetSOSStatus);
    ...
    public static final Buffer commonWriteUtf8CodePoint(Buffer commonWriteUtf8CodePoint, int i) {
        ...
        if (i < 128) {
            ...
            segmentWritableSegment$okio3.data[segmentWritableSegment$okio3.limit] = (byte) ((i >> 18) | Commands.GetSOSStatus);
