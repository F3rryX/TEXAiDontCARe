...
public final class SegmentedByteStringKt {
    ...
    public static final ByteString commonSubstring(SegmentedByteString commonSubstring, int i, int i2) {
        ...
        if (iSegment <= iSegment2) {
            ...
            int i5 = 0;
            while (true) {
                iArr[i5] = Math.min(commonSubstring.getDirectory()[i4] - i, i3);
                int i6 = i5 + 1;
                iArr[i5 + bArr2.length] = commonSubstring.getDirectory()[commonSubstring.getSegments().length + i4];
                if (i4 == iSegment2) {
                    break;
                }
                i4++;
