                ...
                if ((b >> 5) == -2) {
                    ...
                    if (i2 <= i11) {
                        ...
                        if ((b5 & 192) == 128) {
                            ...
                            if ((b6 & 192) == 128) {
                                int i13 = ((b6 ^ (-123008)) ^ (b5 << 6)) ^ (b4 << DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD);
                                if (i13 < 2048) {
                                    i3 = i8 + 1;
                                    cArr[i8] = (char) Utf8.REPLACEMENT_CODE_POINT;
                        ...
                        if (i2 <= i14) {
                            ...
                            if ((b8 & 192) == 128) {
                                ...
                                if ((b9 & 192) == 128) {
                                    ...
                                    if ((b10 & 192) == 128) {
                                        int i17 = (((b10 ^ 3678080) ^ (b9 << 6)) ^ (b8 << DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD)) ^ (b7 << 18);
                                        if (i17 > 1114111) {
                                            i5 = i8 + 1;
                                            cArr[i8] = Utf8.REPLACEMENT_CHARACTER;
                                            ...
                                            char c = (char) ((i17 & Place.TYPE_SUBLOCALITY_LEVEL_1) + Utf8.LOG_SURROGATE_HEADER);
                                            i5 = i18 + 1;
                                            cArr[i18] = c;
                                        }
                ...
                while (i3 < length2) {
                    ...
                    if (Intrinsics.compare((int) cCharAt3, 128) < 0) {
                        ...
                        if (Intrinsics.compare((int) cCharAt3, 2048) < 0) {
                            ...
                            int i9 = i4 + 1;
                            bArr[i4] = (byte) ((iCharAt >> 18) | Commands.GetSOSStatus);
                            int i10 = i9 + 1;
