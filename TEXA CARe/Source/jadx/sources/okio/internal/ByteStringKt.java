        ...
        loop0: while (i3 < length) {
            ...
            if (b >= 0) {
                ...
                if ((b >> 5) == -2) {
                    ...
                    int i11 = ((b7 ^ (-123008)) ^ (b6 << 6)) ^ (b5 << DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD);
                    if (i11 < 2048) {
                        if (i5 == i) {
                            return i4;
                        }
                    ...
                    int i13 = (((b11 ^ 3678080) ^ (b10 << 6)) ^ (b9 << DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD)) ^ (b8 << 18);
                    if (i13 > 1114111) {
                        if (i5 == i) {
                            return i4;
                        }
