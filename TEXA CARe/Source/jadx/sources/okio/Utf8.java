...
public final class Utf8 {
        ...
        while (i < i2) {
            ...
            if (Intrinsics.compare((int) cCharAt2, 128) < 0) {
                ...
                if (Intrinsics.compare((int) cCharAt2, 2048) < 0) {
                    ...
                    yield.invoke(Byte.valueOf((byte) ((iCharAt >> 18) | Commands.GetSOSStatus)));
                ...
                if ((b >> 5) == -2) {
                    ...
                    if (i2 <= i7) {
                        ...
                        if ((b5 & 192) == 128) {
                            ...
                            if ((b6 & 192) == 128) {
                                int i9 = ((b6 ^ (-123008)) ^ (b5 << 6)) ^ (b4 << DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD);
                    ...
                    if (i2 <= i10) {
                        ...
                        if ((b8 & 192) == 128) {
                            ...
                            if ((b9 & 192) == 128) {
                                ...
                                if ((b10 & 192) == 128) {
                                    int i13 = (((b10 ^ 3678080) ^ (b9 << 6)) ^ (b8 << DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD)) ^ (b7 << 18);
                            ...
                            if ((b9 & 192) == 128) {
                                ...
                                if ((b10 & 192) == 128) {
                                    ...
                                    if (i13 <= 1114111 && ((55296 > i13 || 57343 < i13) && i13 >= 65536 && i13 != 65533)) {
                                        ...
                                        yield.invoke(Character.valueOf((char) ((i13 & Place.TYPE_SUBLOCALITY_LEVEL_1) + LOG_SURROGATE_HEADER)));
                                    } else {
                                        yield.invoke(Character.valueOf(REPLACEMENT_CHARACTER));
                                    }
                                    Unit unit8 = Unit.INSTANCE;
    ...
    public static final int process3Utf8Bytes(byte[] process3Utf8Bytes, int i, int i2, Function1<? super Integer, Unit> yield) {
        ...
        int i5 = ((b3 ^ (-123008)) ^ (b2 << 6)) ^ (b << DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD);
        if (i5 < 2048) {
            yield.invoke(numValueOf);
            return 3;
        }
    ...
    public static final int process4Utf8Bytes(byte[] process4Utf8Bytes, int i, int i2, Function1<? super Integer, Unit> yield) {
        ...
        int i6 = (((b4 ^ 3678080) ^ (b3 << 6)) ^ (b2 << DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD)) ^ (b << 18);
        if (i6 > 1114111) {
            yield.invoke(numValueOf);
            return 4;
        }
