...
class Alarms {
    ...
    private static void cancelExactAlarm(Context context, String workSpecId, int alarmId) {
        ...
        PendingIntent service = PendingIntent.getService(context, alarmId, CommandHandler.createDelayMetIntent(context, workSpecId), Build.VERSION.SDK_INT >= 23 ? 603979776 : PKIFailureInfo.duplicateCertReq);
