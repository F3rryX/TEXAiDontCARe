...
public class ConstraintWidget {
    ...
    */
    public void addToSolver(LinearSystem linearSystem) {
        ...
        iArr[0] = i;
        iArr[1] = i4;
        boolean z11 = z5 && ((i6 = this.mResolvedDimensionRatioSide) == 0 || i6 == -1);
    ...
    /* JADX WARN: Removed duplicated region for block: B:176:0x02f4 A[ADDED_TO_REGION] */
    ...
    */
    private void applyConstraints(LinearSystem linearSystem, boolean z, SolverVariable solverVariable, SolverVariable solverVariable2, DimensionBehaviour dimensionBehaviour, boolean z2, ConstraintAnchor constraintAnchor, ConstraintAnchor constraintAnchor2, int i, int i2, int i3, int i4, float f, boolean z3, boolean z4, int i5, int i6, int i7, float f2, boolean z5) {
        ...
        int i18 = zIsConnected2 ? (zIsConnected ? 1 : 0) + 1 : zIsConnected ? 1 : 0;
        if (zIsConnected3) {
            i18++;
        }
        int i19 = i18;
        int i20 = z3 ? 3 : i5;
        int i21 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$solver$widgets$ConstraintWidget$DimensionBehaviour[dimensionBehaviour.ordinal()];
        boolean z15 = (i21 == 1 || i21 == 2 || i21 == 3 || i21 != 4 || i20 == 4) ? false : true;
        if (this.mVisibility == 8) {
            iMin = 0;
            z6 = false;
        } else {
        ...
        if (z6) {
            ...
            if (i22 > 0) {
                linearSystem.addLowerThan(solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable3, i22, 6);
                iMin = Math.min(iMin, i22);
            }
            if (i20 != 1) {
                z7 = z6;
                if (i20 == 2) {
                    ...
                    linearSystem.addConstraint(arrayRowCreateRow.createRowDimensionRatio(solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable3, solverVariable11, solverVariable10, f2));
                    z8 = false;
                    if (z8) {
                        z9 = z8;
                        c3 = c;
        ...
        if (zIsConnected || zIsConnected2 || zIsConnected3) {
            if (!zIsConnected || zIsConnected2) {
                if (zIsConnected || !zIsConnected2) {
                    if (zIsConnected && zIsConnected2) {
                        if (z9) {
                            ...
                            if (i11 == 0) {
                                ...
                                linearSystem.addEquality(solverVariableCreateObjectVariable3, solverVariable6, constraintAnchor.getMargin(), i17);
                                linearSystem.addEquality(solverVariableCreateObjectVariable4, solverVariable5, -constraintAnchor2.getMargin(), i17);
                                z10 = i12 > 0 || i9 > 0;
                                z11 = z14;
                                i13 = 5;
                            } else {
                                ...
                                if (i23 == 1) {
                                    ...
                                    linearSystem.addEquality(solverVariableCreateObjectVariable3, solverVariable6, constraintAnchor.getMargin(), i24);
                                    linearSystem.addEquality(solverVariableCreateObjectVariable4, solverVariable5, -constraintAnchor2.getMargin(), i24);
                                    z10 = true;
                                    z11 = true;
                                    i13 = 5;
                                    if (z10) {
                                        ...
                                        linearSystem.addCentering(solverVariableCreateObjectVariable3, solverVariable6, constraintAnchor.getMargin(), f, solverVariable5, solverVariableCreateObjectVariable4, constraintAnchor2.getMargin(), i13);
                                        ...
                                        if ((z9 && z12) || z11) {
                                            linearSystem.addGreaterThan(solverVariableCreateObjectVariable3, solverVariable7, constraintAnchor.getMargin(), i15);
                                        }
                                        if ((!z9 && z13) || z11) {
                                            linearSystem.addLowerThan(solverVariable9, solverVariable8, -constraintAnchor2.getMargin(), i14);
                                        }
                                        i16 = 6;
                                        if (z) {
                                            linearSystem.addGreaterThan(solverVariableCreateObjectVariable3, solverVariable, 0, 6);
                    ...
                    linearSystem.addGreaterThan(solverVariable2, solverVariable9, 0, i16);
                    return;
                }
