...
public class Optimizer {
    ...
    */
    static boolean applyChainOptimized(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, int i, int i2, ChainHead chainHead) {
        ...
        float f3 = resolutionNode2.target.resolvedOffset;
        float f4 = (margin4 < f3 ? f3 - margin4 : margin4 - f3) - margin2;
        if (i3 > 0 && i3 == i4) {
            ...
            while (constraintWidget11 != null) {
                ...
                if (constraintWidget12 != null || constraintWidget11 == constraintWidget3) {
                    ...
                    if (f2 <= 0.0f) {
                        ...
                        float f7 = margin5 + f;
                        constraintWidget11.mListAnchors[i5].getResolutionNode().resolve(resolutionNode.resolvedTarget, f7);
                        ...
                        margin4 = f7 + constraintWidget11.mListAnchors[i5].getMargin();
                    } else if (constraintWidget11.mWeight[i] != -1.0f) {
                        f6 = (constraintWidget11.mWeight[i] * f5) / f2;
                        f = f6;
                        if (constraintWidget11.getVisibility() == 8) {
                        }
                        float margin52 = margin4 + constraintWidget11.mListAnchors[i2].getMargin();
                        constraintWidget11.mListAnchors[i2].getResolutionNode().resolve(resolutionNode.resolvedTarget, margin52);
                        float f72 = margin52 + f;
                        constraintWidget11.mListAnchors[i5].getResolutionNode().resolve(resolutionNode.resolvedTarget, f72);
                        constraintWidget11.mListAnchors[i2].getResolutionNode().addResolvedValue(linearSystem);
                        constraintWidget11.mListAnchors[i5].getResolutionNode().addResolvedValue(linearSystem);
                        margin4 = f72 + constraintWidget11.mListAnchors[i5].getMargin();
                    } else {
                        f = 0.0f;
                        if (constraintWidget11.getVisibility() == 8) {
                        }
                        float margin522 = margin4 + constraintWidget11.mListAnchors[i2].getMargin();
                        constraintWidget11.mListAnchors[i2].getResolutionNode().resolve(resolutionNode.resolvedTarget, margin522);
                        float f722 = margin522 + f;
                        constraintWidget11.mListAnchors[i5].getResolutionNode().resolve(resolutionNode.resolvedTarget, f722);
                        constraintWidget11.mListAnchors[i2].getResolutionNode().addResolvedValue(linearSystem);
                        constraintWidget11.mListAnchors[i5].getResolutionNode().addResolvedValue(linearSystem);
                        margin4 = f722 + constraintWidget11.mListAnchors[i5].getMargin();
                    }
                }
        ...
        if (!z3) {
            ...
            float f8 = f4 / (i4 + 1);
            if (z2) {
                f8 = f4 / (i4 > 1 ? i4 - 1 : 2.0f);
            }
            float margin6 = constraintWidget13.getVisibility() != 8 ? margin4 + f8 : margin4;
            if (z2 && i4 > 1) {
                margin6 = constraintWidget4.mListAnchors[i2].getMargin() + margin4;
            }
            ...
            while (constraintWidget13 != null) {
                ...
                if (constraintWidget14 != null || constraintWidget13 == constraintWidget3) {
                    ...
                    if (constraintWidget13 != constraintWidget4) {
                        margin6 += constraintWidget13.mListAnchors[i2].getMargin();
                    }
                    constraintWidget13.mListAnchors[i2].getResolutionNode().resolve(resolutionNode.resolvedTarget, margin6);
                    constraintWidget13.mListAnchors[i5].getResolutionNode().resolve(resolutionNode.resolvedTarget, margin6 + f9);
                    ...
                    margin6 += f9 + constraintWidget13.mListAnchors[i5].getMargin();
        ...
        float biasPercent = margin4 + ((f4 - margin) * constraintWidget15.getBiasPercent(i));
        while (true) {
            ...
            if (constraintWidget15 != null || constraintWidget16 == constraintWidget3) {
                ...
                float margin7 = biasPercent + constraintWidget16.mListAnchors[i2].getMargin();
                constraintWidget16.mListAnchors[i2].getResolutionNode().resolve(resolutionNode.resolvedTarget, margin7);
                float f10 = margin7 + height2;
                constraintWidget16.mListAnchors[i5].getResolutionNode().resolve(resolutionNode.resolvedTarget, f10);
                ...
                biasPercent = f10 + constraintWidget16.mListAnchors[i5].getMargin();
            }
        }
    }
