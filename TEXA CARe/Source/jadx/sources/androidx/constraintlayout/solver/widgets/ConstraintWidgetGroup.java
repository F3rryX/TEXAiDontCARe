    ...
    private void updateResolvedDimension(ConstraintWidget constraintWidget) {
        ...
        if (constraintAnchor == null) {
            ...
            if (constraintAnchor.mType == ConstraintAnchor.Type.RIGHT) {
                width = constraintAnchor.mOwner.mX + constraintAnchor.mOwner.getWidth();
        ...
        if (constraintWidget.mBaseline.mTarget != null) {
            ...
            int i = (constraintAnchor3.mOwner.mY + constraintAnchor3.mOwner.mBaselineDistance) - constraintWidget.mBaselineDistance;
