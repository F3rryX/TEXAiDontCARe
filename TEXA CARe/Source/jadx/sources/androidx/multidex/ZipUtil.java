...
final class ZipUtil {
    ...
    static CentralDirectory findCentralDirectory(RandomAccessFile randomAccessFile) throws IOException {
        ...
        long j = length - MockDataID.Status.BRAKE_PAD_LAMP_STATUS;
        long j2 = j >= 0 ? j : 0L;
        ...
        do {
            ...
            if (randomAccessFile.readInt() == iReverseBytes) {
                ...
                centralDirectory.size = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & BodyPartID.bodyIdMax;
                centralDirectory.offset = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & BodyPartID.bodyIdMax;
