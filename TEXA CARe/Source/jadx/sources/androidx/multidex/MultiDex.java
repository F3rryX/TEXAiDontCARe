...
public final class MultiDex {
    ...
    public static void install(Context context) {
        ...
        if (Build.VERSION.SDK_INT < 4) {
            throw new RuntimeException("MultiDex installation failed. SDK " + Build.VERSION.SDK_INT + " is unsupported. Min SDK version is 4" + Version.SEPARATOR);
        }
        try {
    ...
    public static void installInstrumentation(Context context, Context context2) {
        ...
        try {
            ...
            String str = context.getPackageName() + Version.SEPARATOR;
    ...
    static boolean isVMMultidexCapable(String str) {
        boolean z = false;
        if (str != null) {
            StringTokenizer stringTokenizer = new StringTokenizer(str, Version.SEPARATOR);
