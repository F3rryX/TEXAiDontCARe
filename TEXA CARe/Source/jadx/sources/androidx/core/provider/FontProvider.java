...
class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest request, String authority, CancellationSignal cancellationSignal) {
        ...
        Uri uriBuild = new Uri.Builder().scheme(FirebaseAnalytics.Param.CONTENT).authority(authority).build();
        Uri uriBuild2 = new Uri.Builder().scheme(FirebaseAnalytics.Param.CONTENT).authority(authority).appendPath("file").build();
        ...
        try {
            ...
            if (cursorQuery != null && cursorQuery.getCount() > 0) {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    arrayList2.add(FontsContractCompat.FontInfo.create(uriWithAppendedId, i3, columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : SVG.Style.FONT_WEIGHT_NORMAL, columnIndex6 != -1 && cursorQuery.getInt(columnIndex6) == 1, i));
                }
