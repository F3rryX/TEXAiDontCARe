    ...
    static final class Builder {
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            if (annotation instanceof DELETE) {
                parseHttpMethodAndPath(HttpMethod.DELETE, ((DELETE) annotation).value(), false);
                return;
            }
            ...
            if (annotation instanceof HEAD) {
                parseHttpMethodAndPath(HttpMethod.HEAD, ((HEAD) annotation).value(), false);
                return;
            }
            ...
            if (annotation instanceof PUT) {
                parseHttpMethodAndPath(HttpMethod.PUT, ((PUT) annotation).value(), true);
                return;
            }
            if (annotation instanceof OPTIONS) {
                parseHttpMethodAndPath(HttpMethod.OPTIONS, ((OPTIONS) annotation).value(), false);
                return;
            }
        ...
        private Headers parseHeaders(String[] strArr) {
            ...
            for (String str : strArr) {
                ...
                if (TexaCareServiceBus.HEADER_CONTENT_TYPE.equalsIgnoreCase(strSubstring)) {
                    try {
