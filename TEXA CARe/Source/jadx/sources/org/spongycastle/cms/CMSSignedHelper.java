...
class CMSSignedHelper {
    ...
    static {
        ...
        map3.put("SHA1", new String[]{McElieceCCA2KeyGenParameterSpec.SHA1});
        map3.put("SHA224", new String[]{McElieceCCA2KeyGenParameterSpec.SHA224});
        map3.put("SHA256", new String[]{McElieceCCA2KeyGenParameterSpec.SHA256});
        map3.put("SHA384", new String[]{McElieceCCA2KeyGenParameterSpec.SHA384});
        map3.put("SHA512", new String[]{McElieceCCA2KeyGenParameterSpec.SHA512});
    }
