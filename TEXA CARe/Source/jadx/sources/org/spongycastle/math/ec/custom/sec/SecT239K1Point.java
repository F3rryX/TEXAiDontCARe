...
public class SecT239K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElementMultiply.isZero()) {
            return new SecT239K1Point(curve, eCFieldElementMultiply, curve.getB(), this.withCompression);
        }
