        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            if (coordinateSystem == 1) {
                ...
                if (eCFieldElementSubtract5.isZero()) {
                    if (eCFieldElementSubtract4.isZero()) {
                        return twice();
                    }
                    return curve.getInfinity();
                }
                if (zIsOne) {
                    eCFieldElementMultiply6 = eCFieldElement3;
                } else if (!zIsOne2) {
                    eCFieldElementMultiply6 = eCFieldElementMultiply6.multiply(eCFieldElement3);
                }
                ECFieldElement eCFieldElementSquare2 = eCFieldElementSubtract5.square();
                ECFieldElement eCFieldElementMultiply7 = eCFieldElementSquare2.multiply(eCFieldElementSubtract5);
                ECFieldElement eCFieldElementMultiply8 = eCFieldElementSquare2.multiply(eCFieldElementMultiply2);
            ...
            if (coordinateSystem == 2 || coordinateSystem == 4) {
                ECFieldElement eCFieldElement4 = this.zs[0];
                ECFieldElement eCFieldElement5 = eCPoint.zs[0];
                boolean zIsOne3 = eCFieldElement4.isOne();
                if (!zIsOne3 && eCFieldElement4.equals(eCFieldElement5)) {
                    ...
                    ECFieldElement eCFieldElementSquare3 = eCFieldElementSubtract7.square();
                    ECFieldElement eCFieldElementMultiply9 = eCFieldElementMultiply2.multiply(eCFieldElementSquare3);
                    ECFieldElement eCFieldElementMultiply10 = eCFieldElementMultiply4.multiply(eCFieldElementSquare3);
                    ...
                    ECFieldElement eCFieldElementSubtract9 = eCFieldElementSubtract8.square().subtract(eCFieldElementMultiply9).subtract(eCFieldElementMultiply10);
                    ECFieldElement eCFieldElementSubtract10 = eCFieldElementMultiply9.subtract(eCFieldElementSubtract9).multiply(eCFieldElementSubtract8).subtract(eCFieldElementMultiply11);
                    eCFieldElementMultiply = eCFieldElementSubtract7.multiply(eCFieldElement4);
                    ...
                    if (!zIsOne3) {
                        ...
                        eCFieldElementMultiply4 = eCFieldElementSquare4.multiply(eCFieldElementMultiply4);
                        eCFieldElementMultiply5 = eCFieldElementSquare4.multiply(eCFieldElement4).multiply(eCFieldElementMultiply5);
                    }
                    boolean zIsOne4 = eCFieldElement5.isOne();
                    if (!zIsOne4) {
                        ECFieldElement eCFieldElementSquare5 = eCFieldElement5.square();
                        eCFieldElementMultiply2 = eCFieldElementSquare5.multiply(eCFieldElementMultiply2);
                        eCFieldElementMultiply3 = eCFieldElementSquare5.multiply(eCFieldElement5).multiply(eCFieldElementMultiply3);
                    }
                    ...
                    eCFieldElementSquare = eCFieldElementSubtract11.square();
                    ECFieldElement eCFieldElementMultiply12 = eCFieldElementSquare.multiply(eCFieldElementSubtract11);
                    ECFieldElement eCFieldElementMultiply13 = eCFieldElementSquare.multiply(eCFieldElementMultiply2);
                    ECFieldElement eCFieldElementSubtract13 = eCFieldElementSubtract12.square().add(eCFieldElementMultiply12).subtract(two(eCFieldElementMultiply13));
                    ECFieldElement eCFieldElementMultiplyMinusProduct = eCFieldElementMultiply13.subtract(eCFieldElementSubtract13).multiplyMinusProduct(eCFieldElementSubtract12, eCFieldElementMultiply12, eCFieldElementMultiply3);
                    ECFieldElement eCFieldElementMultiply14 = !zIsOne3 ? eCFieldElementSubtract11.multiply(eCFieldElement4) : eCFieldElementSubtract11;
                    eCFieldElementMultiply = !zIsOne4 ? eCFieldElementMultiply14.multiply(eCFieldElement5) : eCFieldElementMultiply14;
                    eCFieldElement = eCFieldElementMultiplyMinusProduct;
                    eCFieldElement2 = eCFieldElementSubtract13;
                    if (eCFieldElementMultiply != eCFieldElementSubtract11) {
                    }
                    return new Fp(curve, eCFieldElement2, eCFieldElement, coordinateSystem != 4 ? new ECFieldElement[]{eCFieldElementMultiply, calculateJacobianModifiedW(eCFieldElementMultiply, eCFieldElementSquare)} : new ECFieldElement[]{eCFieldElementMultiply}, this.withCompression);
                }
