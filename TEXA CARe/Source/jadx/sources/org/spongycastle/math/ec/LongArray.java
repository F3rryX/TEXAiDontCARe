...
class LongArray implements Cloneable {
    ...
    private static void multiplyWord(long j, long[] jArr, int i, long[] jArr2, int i2) {
        ...
        while (true) {
            ...
            if ((j3 & 1) != 0) {
                long jAddShiftedUp = addShiftedUp(jArr2, i2, jArr, 0, i, i3);
                if (jAddShiftedUp != 0) {
                    int i4 = i2 + i;
                    jArr2[i4] = jAddShiftedUp ^ jArr2[i4];
                }
            }
            i3++;
            j2 = j3;
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        if (i6 == 1) {
            ...
            return reduceResult(jArr, 0, i8, i, iArr);
        }
        int i9 = 15;
        int i10 = ((i3 + 15) + 63) >>> 6;
        int i11 = i10 * 8;
        ...
        long[] jArr2 = new long[i12 + i8 + 1];
        int i14 = i11;
        interleave(longArray2.m_ints, 0, jArr2, 0, i6, 4);
        System.arraycopy(longArray3.m_ints, 0, jArr2, i6, i7);
        int i15 = i6;
        int i16 = 1;
        while (i16 < 8) {
            int i17 = i15 + i10;
            shiftUp(jArr2, i6, jArr2, i17, i10, i16);
            i16++;
            i15 = i17;
        }
        int i18 = 0;
        while (true) {
            ...
            do {
                ...
                while (true) {
                    int i22 = ((int) j2) & i9;
                    if (i22 != 0) {
                        add(jArr2, iArr2[i22] + i19, jArr2, i20, i10);
                    }
                    i4 = 1;
                    i21++;
                    if (i21 == 8) {
        ...
        while (true) {
            int i24 = i23 - 1;
            if (i24 <= i4) {
                return reduceResult(jArr2, iArr2[1], i8, i, iArr);
            }
            if ((((long) i24) & 1) == 0) {
                addShiftedUp(jArr2, iArr2[i24 >>> 1], jArr2, iArr2[i24], i8, 16);
            } else {
                distribute(jArr2, iArr2[i24], iArr2[i24 - 1], iArr2[1], i8);
            }
            i23 = i24;
            i4 = 1;
        }
    ...
    public LongArray multiply(LongArray longArray, int i, int[] iArr) {
        ...
        for (int i15 = 0; i15 < i5; i15++) {
            ...
            while (true) {
                long j3 = j2 >>> 4;
                int i17 = i16;
                addBoth(jArr7, i17, jArr4, iArr2[((int) j2) & 15], jArr5, iArr2[((int) j3) & 15], i8);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
    ...
    private static int reduceInPlace(long[] jArr, int i, int i2, int i3, int[] iArr) {
        ...
        if (iMin > iMax) {
            reduceWordWise(jArr, i, i7, iMax, i3, iArr);
        } else {
            iMax = iMin;
        }
        if (iMax > i3) {
    ...
    private static long interleave3_21to63(int i) {
        ...
        int i2 = iArr[i & 127];
        return (((long) i2) & BodyPartID.bodyIdMax) | ((((long) iArr[i >>> 14]) & BodyPartID.bodyIdMax) << 42) | ((((long) iArr[(i >>> 7) & 127]) & BodyPartID.bodyIdMax) << 21);
    }
    ...
    private static long interleave3_13to65(int i) {
        ...
        int i2 = iArr[i & 127];
        return (((long) i2) & BodyPartID.bodyIdMax) | ((((long) iArr[i >>> 7]) & BodyPartID.bodyIdMax) << 35);
    }
    ...
    private static long interleave4_16to64(int i) {
        ...
        int i2 = iArr[i & 255];
        return (((long) i2) & BodyPartID.bodyIdMax) | ((((long) iArr[i >>> 8]) & BodyPartID.bodyIdMax) << 32);
    }

    private static long interleave2_32to64(int i) {
        short[] sArr = INTERLEAVE2_TABLE;
        int i2 = sArr[i & 255] | (sArr[(i >>> 8) & 255] << 16);
        return (((long) i2) & BodyPartID.bodyIdMax) | ((((long) ((sArr[i >>> 24] << 16) | sArr[(i >>> 16) & 255])) & BodyPartID.bodyIdMax) << 32);
    }
