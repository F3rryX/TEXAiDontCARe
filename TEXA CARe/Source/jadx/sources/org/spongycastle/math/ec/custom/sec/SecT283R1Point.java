...
public class SecT283R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        return new SecT283R1Point(curve, eCFieldElementMultiply2, eCFieldElementMultiplyPlusProduct.add(eCFieldElementSquare4).square().multiplyPlusProduct(eCFieldElementAdd, rawYCoord.addOne(), eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3}, this.withCompression);
    }
