...
public abstract class Nat224 {
    ...
    public static void mul(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i6 < 7) {
            i5 += i4;
            long j17 = ((long) iArr[i + i6]) & 4294967295L;
            int i7 = i5 + 0;
            long j18 = (j17 * j) + (((long) iArr3[i7]) & 4294967295L) + 0;
            iArr3[i7] = (int) j18;
            int i8 = i5 + 1;
            long j19 = j15;
            long j20 = (j18 >>> 32) + (j17 * j2) + (((long) iArr3[i8]) & 4294967295L);
            iArr3[i8] = (int) j20;
            int i9 = i5 + 2;
            long j21 = j3;
            long j22 = (j20 >>> 32) + (j17 * j3) + (((long) iArr3[i9]) & 4294967295L);
            iArr3[i9] = (int) j22;
            int i10 = i5 + 3;
            long j23 = (j22 >>> 32) + (j17 * j4) + (((long) iArr3[i10]) & 4294967295L);
            iArr3[i10] = (int) j23;
            int i11 = i5 + 4;
            long j24 = (j23 >>> 32) + (j17 * j5) + (((long) iArr3[i11]) & 4294967295L);
            iArr3[i11] = (int) j24;
            int i12 = i5 + 5;
            long j25 = (j24 >>> 32) + (j17 * j6) + (((long) iArr3[i12]) & 4294967295L);
            iArr3[i12] = (int) j25;
            int i13 = i5 + 6;
            long j26 = (j25 >>> 32) + (j17 * j19) + (((long) iArr3[i13]) & 4294967295L);
            iArr3[i13] = (int) j26;
    ...
    public static int mulAddTo(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i < 7) {
            ...
            int i3 = i + 1;
            long j14 = j3;
            long j15 = (j13 >>> 32) + (j11 * j3) + (((long) iArr3[i3]) & j);
            iArr3[i3] = (int) j15;
            int i4 = i + 2;
            long j16 = (j15 >>> 32) + (j11 * j4) + (((long) iArr3[i4]) & j);
            iArr3[i4] = (int) j16;
            int i5 = i + 3;
            long j17 = (j16 >>> 32) + (j11 * j5) + (((long) iArr3[i5]) & j);
            iArr3[i5] = (int) j17;
            int i6 = i + 4;
            long j18 = (j17 >>> 32) + (j11 * j6) + (((long) iArr3[i6]) & j);
            iArr3[i6] = (int) j18;
            int i7 = i + 5;
