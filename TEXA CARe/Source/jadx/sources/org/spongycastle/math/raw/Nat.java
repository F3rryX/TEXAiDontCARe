...
public abstract class Nat {
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            int i3 = i2 + i;
            long jMulWordAddTo = (((long) mulWordAddTo(i, iArr[i2], iArr2, 0, iArr3, i2)) & 4294967295L) + j + (4294967295L & ((long) iArr3[i3]));
            iArr3[i3] = (int) jMulWordAddTo;
            j = jMulWordAddTo >>> 32;
        }
        return (int) j;
    }
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i6 = 0; i6 < i; i6++) {
            int i7 = i5 + i;
            long jMulWordAddTo = (((long) mulWordAddTo(i, iArr[i2 + i6], iArr2, i3, iArr3, i5)) & 4294967295L) + j + (4294967295L & ((long) iArr3[i7]));
