...
public class ArmoredOutputStream extends OutputStream {
    ...
    public void resetHeaders() {
        this.headers.clear();
        this.headers.put(TermsModel.VERSION, this.version);
    }
    ...
    public void write(int i) throws IOException {
        ...
        if (this.start) {
            ...
            writeHeaderEntry(TermsModel.VERSION, (String) this.headers.get(TermsModel.VERSION));
            Enumeration enumerationKeys = this.headers.keys();
            while (enumerationKeys.hasMoreElements()) {
                String str = (String) enumerationKeys.nextElement();
                if (!str.equals(TermsModel.VERSION)) {
