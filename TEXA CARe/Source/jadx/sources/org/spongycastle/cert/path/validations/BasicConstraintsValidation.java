...
public class BasicConstraintsValidation implements CertPathValidation {
    ...
    public void validate(CertPathValidationContext certPathValidationContext, X509CertificateHolder x509CertificateHolder) throws CertPathValidationException {
        ...
        if (basicConstraintsFromExtensions != null) {
            if (this.bc != null) {
                if (basicConstraintsFromExtensions.isCA() && (pathLenConstraint = basicConstraintsFromExtensions.getPathLenConstraint()) != null && (iIntValue = pathLenConstraint.intValue()) < this.maxPathLength) {
