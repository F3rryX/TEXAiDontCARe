...
public class BCECGOST3410_2012PublicKey implements ECPublicKey, org.spongycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            int i = algorithm.equals(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512) ? 128 : 64;
            int i2 = i / 2;
    ...
    public byte[] getEncoded() {
        ...
        if (x962Parameters == null) {
            ...
            if (!(eCParameterSpec instanceof ECNamedCurveSpec)) {
                ...
                x962Parameters = new GOST3410PublicKeyAlgParameters(ECGOST3410NamedCurves.getOID(((ECNamedCurveSpec) this.ecSpec).getName()), RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512);
            } else {
                x962Parameters = new GOST3410PublicKeyAlgParameters(ECGOST3410NamedCurves.getOID(((ECNamedCurveSpec) this.ecSpec).getName()), RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256);
            }
        }
        int i2 = 64;
        if (z) {
