...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    /* JADX WARN: Type inference failed for: r5v17, types: [org.spongycastle.crypto.CipherParameters, org.spongycastle.crypto.params.RC5Parameters] */
    /* JADX WARN: Type inference failed for: r5v20, types: [org.spongycastle.crypto.CipherParameters, org.spongycastle.crypto.params.RC2Parameters] */
    /* JADX WARN: Type inference failed for: r5v23 */
    /* JADX WARN: Type inference failed for: r5v24, types: [org.spongycastle.crypto.CipherParameters, org.spongycastle.crypto.params.ParametersWithSBox] */
    ...
    /* JADX WARN: Type inference failed for: r5v32, types: [org.spongycastle.crypto.CipherParameters] */
    /* JADX WARN: Type inference failed for: r5v33 */
    /* JADX WARN: Type inference failed for: r5v36 */
    /* JADX WARN: Type inference failed for: r5v37, types: [org.spongycastle.crypto.params.AEADParameters] */
    ...
    protected void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec instanceof AEADParameterSpec) {
            ...
            if (rC5Parameters instanceof ParametersWithIV) {
                ...
                keyParameter2 = (KeyParameter) rC5Parameters;
            }
            ...
            if (this.baseEngine.getAlgorithmName().startsWith("RC5")) {
                if (this.baseEngine.getAlgorithmName().equals("RC5-32")) {
                    if (rC5ParameterSpec.getWordSize() != 32) {
                        throw new InvalidAlgorithmParameterException("RC5 already set up for a word size of 32 not " + rC5ParameterSpec.getWordSize() + Version.SEPARATOR);
                    }
                } else if (this.baseEngine.getAlgorithmName().equals("RC5-64") && rC5ParameterSpec.getWordSize() != 64) {
                    throw new InvalidAlgorithmParameterException("RC5 already set up for a word size of 64 not " + rC5ParameterSpec.getWordSize() + Version.SEPARATOR);
                }
            ...
            if (cls != null && cls.isInstance(algorithmParameterSpec)) {
                ...
                try {
                    ...
                    if (rC5Parameters instanceof ParametersWithIV) {
                        ...
                        keyParameter = (KeyParameter) rC5Parameters;
                    }
            ...
            if (!z6) {
                ...
                if (!z7) {
                    ...
                    if (i == 1 || i == 3) {
                        ...
                        ParametersWithIV parametersWithIV3 = new ParametersWithIV(rC5Parameters, bArr);
