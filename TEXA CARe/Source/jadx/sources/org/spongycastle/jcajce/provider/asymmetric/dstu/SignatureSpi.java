...
public class SignatureSpi extends java.security.SignatureSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
    private static byte[] DEFAULT_SBOX = {10, 9, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MAX_THRESHOLD, 6, DataManagerParameterID.LED_ALWAYS_ON, DataManagerParameterID.ACCELERATION_MAX_RANGE, 4, 5, 15, 1, 3, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD, 7, 0, 8, 2, 8, 0, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD, 4, 9, 6, 7, DataManagerParameterID.ACCELERATION_MAX_RANGE, 2, 3, 1, 15, 5, DataManagerParameterID.LED_ALWAYS_ON, 10, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MAX_THRESHOLD, 15, 6, 5, 8, DataManagerParameterID.LED_ALWAYS_ON, DataManagerParameterID.ACCELERATION_MAX_RANGE, 10, 4, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD, 0, 3, 7, 2, 9, 1, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MAX_THRESHOLD, 3, 8, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MAX_THRESHOLD, 9, 6, DataManagerParameterID.ACCELERATION_MAX_RANGE, 15, 0, 2, 5, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD, 10, 4, DataManagerParameterID.LED_ALWAYS_ON, 1, 7, 15, 8, DataManagerParameterID.LED_ALWAYS_ON, 9, 7, 2, 0, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MAX_THRESHOLD, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD, 6, 1, 5, DataManagerParameterID.ACCELERATION_MAX_RANGE, 4, 3, 10, 2, 8, 9, 7, 5, 15, 0, DataManagerParameterID.ACCELERATION_MAX_RANGE, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD, 1, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MAX_THRESHOLD, DataManagerParameterID.LED_ALWAYS_ON, 10, 3, 6, 4, 3, 8, DataManagerParameterID.ACCELERATION_MAX_RANGE, 5, 6, 4, DataManagerParameterID.LED_ALWAYS_ON, 10, 2, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD, 1, 7, 9, 15, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MAX_THRESHOLD, 0, 1, 2, 3, DataManagerParameterID.LED_ALWAYS_ON, 6, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MAX_THRESHOLD, DataManagerParameterID.ACCELERATION_MAX_RANGE, 8, 15, 10, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD, 5, 7, 9, 0, 4};
