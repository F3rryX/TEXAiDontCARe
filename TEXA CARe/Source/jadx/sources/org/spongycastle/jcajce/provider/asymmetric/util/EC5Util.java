...
public class EC5Util {
    ...
    public static org.spongycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec eCParameterSpec, boolean z) {
        ...
        return new org.spongycastle.jce.spec.ECParameterSpec(eCCurveConvertCurve, convertPoint(eCCurveConvertCurve, eCParameterSpec.getGenerator(), z), eCParameterSpec.getOrder(), BigInteger.valueOf(eCParameterSpec.getCofactor()), eCParameterSpec.getCurve().getSeed());
    }
