...
class RFC3280CertPathUtilities {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:38:0x00f2, code lost:
        ...
        if (org.spongycastle.jce.provider.RFC3280CertPathUtilities.ANY_POLICY.equals(r9.getPolicyIdentifier().getId()) == false) goto L105;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:52:0x0132, code lost:
        ...
        if (org.spongycastle.jce.provider.RFC3280CertPathUtilities.ANY_POLICY.equals(r9.getValidPolicy()) == false) goto L95;
     */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:45:0x00fb A[PHI: r0
      0x00fb: PHI (r0v13 'e' org.spongycastle.jce.provider.AnnotatedException) = 
      (r0v12 'e' org.spongycastle.jce.provider.AnnotatedException)
      (r0v27 'e' org.spongycastle.jce.provider.AnnotatedException)
      (r0v12 'e' org.spongycastle.jce.provider.AnnotatedException)
     binds: [B:35:0x00a5, B:41:0x00f1, B:37:0x00ab] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
                        ...
                        if (distributionPoints != null) {
                            ...
                            for (int i4 = 11; i3 < distributionPoints.length && certStatus.getCertStatus() == i4 && !reasonsMask.isAllReasons(); i4 = 11) {
                                try {
                                    ...
                                    try {
                                        checkCRL(distributionPoints[i3], pKIXExtendedParametersBuild, x509Certificate, date, x509Certificate2, publicKey, certStatus, reasonsMask, list, jcaJceHelper);
                                        z = true;
                                    } catch (AnnotatedException e2) {
                                        e = e2;
                                    }
