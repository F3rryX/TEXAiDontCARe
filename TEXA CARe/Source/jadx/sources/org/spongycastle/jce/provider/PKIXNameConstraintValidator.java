...
public class PKIXNameConstraintValidator {
    ...
    private boolean withinDomain(String str, String str2) {
        if (str2.startsWith(Version.SEPARATOR)) {
    ...
    private void unionEmail(String str, String str2, Set set) {
        ...
        if (str.startsWith(Version.SEPARATOR)) {
            if (str2.indexOf(64) != -1) {
    ...
    private void intersectEmail(String str, String str2, Set set) {
        if (str.indexOf(64) != -1) {
            ...
            if (str2.indexOf(64) != -1) {
                ...
                return;
            } else if (str2.startsWith(Version.SEPARATOR)) {
                if (withinDomain(strSubstring, str2)) {
                    set.add(str);
                    return;
                }
    ...
    private boolean isUriConstrained(String str, String str2) {
        ...
        return !str2.startsWith(Version.SEPARATOR) ? strExtractHostFromURL.equalsIgnoreCase(str2) : withinDomain(strExtractHostFromURL, str2);
    }
    ...
    private String stringifyIP(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length / 2; i++) {
            str = str + Integer.toString(bArr[i] & 255) + Version.SEPARATOR;
        }
        String str2 = str.substring(0, str.length() - 1) + "/";
        for (int length = bArr.length / 2; length < bArr.length; length++) {
            str2 = str2 + Integer.toString(bArr[length] & 255) + Version.SEPARATOR;
        }
