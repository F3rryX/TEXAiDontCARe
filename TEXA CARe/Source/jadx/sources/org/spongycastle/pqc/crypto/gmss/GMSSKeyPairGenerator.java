...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        for (int i8 = this.numLayer - i4; i8 >= 0; i8--) {
            GMSSRootCalc gMSSRootCalc = new GMSSRootCalc(this.heightOfTrees[i8], this.K[i8], this.digestProvider);
            try {
                if (i8 == this.numLayer - 1) {
                    try {
                        gMSSRootCalcGenerateCurrentAuthpathAndRoot = generateCurrentAuthpathAndRoot(null, vectorArr[i8], bArr5[i8], i8);
                    } catch (Exception e) {
                        e = e;
                        e.printStackTrace();
                    }
                } else {
                    gMSSRootCalcGenerateCurrentAuthpathAndRoot = generateCurrentAuthpathAndRoot(bArr3[i8 + 1], vectorArr[i8], bArr5[i8], i8);
                }
                gMSSRootCalc = gMSSRootCalcGenerateCurrentAuthpathAndRoot;
            } catch (Exception e2) {
                e = e2;
            ...
            vectorArr3[i8] = gMSSRootCalc.getRetain();
            treehashArr[i8] = gMSSRootCalc.getTreehash();
            System.arraycopy(gMSSRootCalc.getRoot(), 0, bArr3[i8], 0, this.mdLength);
        }
        int i10 = this.numLayer - 2;
        while (i10 >= 0) {
            int i11 = i10 + 1;
            GMSSRootCalc gMSSRootCalcGenerateNextAuthpathAndRoot = generateNextAuthpathAndRoot(vectorArr2[i10], bArr5[i11], i11);
            int i12 = 0;
            while (i12 < this.heightOfTrees[i11]) {
                System.arraycopy(gMSSRootCalcGenerateNextAuthpathAndRoot.getAuthPath()[i12], 0, bArr2[i10][i12], 0, this.mdLength);
                i12++;
                vectorArr3 = vectorArr3;
            }
            vectorArr6[i10] = gMSSRootCalcGenerateNextAuthpathAndRoot.getRetain();
            treehashArr2[i10] = gMSSRootCalcGenerateNextAuthpathAndRoot.getTreehash();
            System.arraycopy(gMSSRootCalcGenerateNextAuthpathAndRoot.getRoot(), 0, bArr4[i10], 0, this.mdLength);
