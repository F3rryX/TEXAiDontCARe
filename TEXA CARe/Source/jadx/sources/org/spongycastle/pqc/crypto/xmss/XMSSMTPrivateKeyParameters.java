...
public final class XMSSMTPrivateKeyParameters extends AsymmetricKeyParameter implements XMSSStoreableObjectInterface {
    ...
    private XMSSMTPrivateKeyParameters(Builder builder) {
        ...
        if (bArr != null) {
            ...
            byte[] bArrExtractBytesAtOffset = XMSSUtil.extractBytesAtOffset(bArr, i6, bArr.length - i6);
            BDSStateMap bDSStateMap = null;
            try {
                bDSStateMap = (BDSStateMap) XMSSUtil.deserialize(bArrExtractBytesAtOffset);
            } catch (IOException e) {
                e.printStackTrace();
