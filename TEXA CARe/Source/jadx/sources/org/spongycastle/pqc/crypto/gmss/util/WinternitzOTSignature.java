...
public class WinternitzOTSignature {
    ...
    public WinternitzOTSignature(byte[] bArr, Digest digest, int i) {
        ...
        this.keysize = iCeil2;
        this.privateKeyOTS = (byte[][]) Array.newInstance((Class<?>) byte.class, iCeil2, this.mdsize);
        int i2 = this.mdsize;
