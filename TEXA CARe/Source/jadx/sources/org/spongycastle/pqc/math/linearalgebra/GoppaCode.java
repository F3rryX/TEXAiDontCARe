...
public final class GoppaCode {
    ...
    public static GF2Vector syndromeDecode(GF2Vector gF2Vector, GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM, PolynomialGF2mSmallM[] polynomialGF2mSmallMArr) {
        ...
        if (!gF2Vector.isZero()) {
            ...
            PolynomialGF2mSmallM polynomialGF2mSmallMAdd = polynomialGF2mSmallMArrModPolynomialToFracton[0].multiply(polynomialGF2mSmallMArrModPolynomialToFracton[0]).add(polynomialGF2mSmallMArrModPolynomialToFracton[1].multiply(polynomialGF2mSmallMArrModPolynomialToFracton[1]).multWithMonomial(1));
