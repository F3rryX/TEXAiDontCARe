...
public class IntegerPolynomial implements Polynomial {
    ...
    public Resultant resultant() {
        ...
        while (true) {
            ...
            BigInteger bigIntegerMod = bigInteger3.multiply(bigIntEuclideanCalculate.x.multiply(bigIntegerNextPrime)).add(modularResultantResultant.res.multiply(bigIntEuclideanCalculate.y.multiply(bigInteger))).mod(bigIntegerMultiply);
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (bigInteger4.compareTo(bigIntegerDivide2) > 0) {
                bigIntPolynomial.coeffs[i2] = bigInteger4.subtract(bigIntegerMultiply);
            }
            if (bigInteger4.compareTo(bigIntegerNegate2) < 0) {
                bigIntPolynomial.coeffs[i2] = bigInteger4.add(bigIntegerMultiply);
            }
        }
    ...
    */
    ...
    private BigInteger squareSum() {
        ...
        while (true) {
            ...
            bigIntegerAdd = bigIntegerAdd.add(BigInteger.valueOf(r2[i] * r2[i]));
            i++;
        }
    }
    ...
    void shiftGap(int i) {
        ...
        while (i3 < iArrClone.length - 1) {
            int i6 = i3 + 1;
            int i7 = iArrClone[i6] - iArrClone[i3];
            if (i7 > i4) {
                i5 = iArrClone[i3];
                i4 = i7;
            }
        ...
        int i8 = iArrClone[0];
        int i9 = iArrClone[iArrClone.length - 1];
        if ((i - i9) + i8 > i4) {
            i2 = (i9 + i8) / 2;
        } else {
            i2 = i5 + (i4 / 2) + (i / 2);
