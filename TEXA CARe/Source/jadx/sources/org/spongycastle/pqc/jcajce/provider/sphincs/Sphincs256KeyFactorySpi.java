...
public class Sphincs256KeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        throw new InvalidKeySpecException("Unsupported key specification: " + keySpec.getClass() + Version.SEPARATOR);
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        throw new InvalidKeySpecException("Unknown key specification: " + keySpec + Version.SEPARATOR);
    }
    ...
    public final KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        if (key instanceof BCSphincs256PrivateKey) {
            ...
            throw new InvalidKeySpecException("Unsupported key type: " + key.getClass() + Version.SEPARATOR);
        }
        throw new InvalidKeySpecException("Unknown key specification: " + cls + Version.SEPARATOR);
    }
