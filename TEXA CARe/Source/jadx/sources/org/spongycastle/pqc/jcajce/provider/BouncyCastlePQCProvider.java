...
public class BouncyCastlePQCProvider extends Provider implements ConfigurableProvider {
    ...
    public boolean hasAlgorithm(String str, String str2) {
        if (!containsKey(str + Version.SEPARATOR + str2)) {
            if (!containsKey("Alg.Alias." + str + Version.SEPARATOR + str2)) {
                return false;
            }
        }
        return true;
    ...
    public void addAlgorithm(String str, ASN1ObjectIdentifier aSN1ObjectIdentifier, String str2) {
        if (!containsKey(str + Version.SEPARATOR + str2)) {
            throw new IllegalStateException("primary key (" + str + Version.SEPARATOR + str2 + ") not found");
        }
        addAlgorithm(str + Version.SEPARATOR + aSN1ObjectIdentifier, str2);
    ...
    static Class loadClass(Class cls, final String str) {
        try {
            ...
            return (Class) AccessController.doPrivileged(new PrivilegedAction() { // from class: org.spongycastle.pqc.jcajce.provider.BouncyCastlePQCProvider.2
                @Override // java.security.PrivilegedAction
                public Object run() {
                    try {
