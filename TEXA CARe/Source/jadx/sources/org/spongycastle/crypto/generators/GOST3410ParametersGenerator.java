...
public class GOST3410ParametersGenerator {
    ...
    private int procedure_A(int i, int i2, BigInteger[] bigIntegerArr, int i3) {
        ...
        while (i11 < i8) {
            ...
            while (true) {
                ...
                int i16 = i10 + 1;
                BigInteger bigIntegerAdd = bigInteger7.pow(iArr[i10] - 1).divide(bigIntegerArr4[i16]).add(bigInteger7.pow(iArr[i10] - 1).multiply(bigInteger6).divide(bigIntegerArr4[i16].multiply(bigInteger7.pow(i12 * 16))));
                ...
                while (true) {
                    ...
                    bigIntegerArr4[i10] = bigIntegerMultiply.add(bigInteger9);
                    BigInteger bigInteger10 = bigIntegerArr4[i10];
                    BigInteger bigInteger11 = TWO;
                    i5 = i12;
                    if (bigInteger10.compareTo(bigInteger11.pow(iArr[i10])) == 1) {
                        break;
                    }
                    if (bigInteger11.modPow(bigIntegerArr4[i16].multiply(bigIntegerAdd.add(BigInteger.valueOf(j))), bigIntegerArr4[i10]).compareTo(bigInteger9) == 0 && bigInteger11.modPow(bigIntegerAdd.add(BigInteger.valueOf(j)), bigIntegerArr4[i10]).compareTo(bigInteger9) != 0) {
                        break;
                    }
                    i17 += 2;
                    i8 = i4;
        ...
        while (i7 < i5) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    BigInteger bigInteger9 = ONE;
                    bigIntegerArr4[i6] = bigIntegerMultiply.add(bigInteger9);
                    ...
                    if (bigInteger11.modPow(bigIntegerArr4[i13].multiply(bigIntegerAdd.add(BigInteger.valueOf(j3))), bigIntegerArr4[i6]).compareTo(bigInteger9) == 0 && bigInteger11.modPow(bigIntegerAdd.add(BigInteger.valueOf(j3)), bigIntegerArr4[i6]).compareTo(bigInteger9) != 0) {
                        break;
                    }
                    i14 += 2;
                    bigInteger3 = bigInteger;
    ...
    private void procedure_B(int i, int i2, BigInteger[] bigIntegerArr) {
        ...
        while (true) {
            ...
            int i6 = 1024;
            BigInteger bigIntegerAdd = bigInteger6.pow(Place.TYPE_SUBLOCALITY_LEVEL_1).divide(bigInteger3.multiply(bigInteger4)).add(bigInteger6.pow(Place.TYPE_SUBLOCALITY_LEVEL_1).multiply(bigInteger5).divide(bigInteger3.multiply(bigInteger4).multiply(bigInteger6.pow(1024))));
