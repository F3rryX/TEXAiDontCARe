...
public class HC256Engine implements StreamCipher {
    ...
    private int step() {
        ...
        if (i3 < 1024) {
            ...
            int i7 = iArr[i4];
            int iRotateRight = iArr[(i4 - 10) & Place.TYPE_SUBLOCALITY_LEVEL_1] + (rotateRight(i6, 23) ^ rotateRight(i5, 10));
            int[] iArr2 = this.q;
            iArr[i4] = i7 + iRotateRight + iArr2[(i5 ^ i6) & Place.TYPE_SUBLOCALITY_LEVEL_1];
            int[] iArr3 = this.p;
            int i8 = iArr3[(i4 - 12) & Place.TYPE_SUBLOCALITY_LEVEL_1];
            i = iArr2[i8 & 255] + iArr2[((i8 >> 8) & 255) + 256] + iArr2[((i8 >> 16) & 255) + 512] + iArr2[((i8 >> 24) & 255) + 768];
            i2 = iArr3[i4];
        } else {
            int[] iArr4 = this.q;
            int i9 = iArr4[(i4 - 3) & Place.TYPE_SUBLOCALITY_LEVEL_1];
            int i10 = iArr4[(i4 - 1023) & Place.TYPE_SUBLOCALITY_LEVEL_1];
            int i11 = iArr4[i4];
            int iRotateRight2 = iArr4[(i4 - 10) & Place.TYPE_SUBLOCALITY_LEVEL_1] + (rotateRight(i10, 23) ^ rotateRight(i9, 10));
            int[] iArr5 = this.p;
            iArr4[i4] = i11 + iRotateRight2 + iArr5[(i9 ^ i10) & Place.TYPE_SUBLOCALITY_LEVEL_1];
            int[] iArr6 = this.q;
            int i12 = iArr6[(i4 - 12) & Place.TYPE_SUBLOCALITY_LEVEL_1];
