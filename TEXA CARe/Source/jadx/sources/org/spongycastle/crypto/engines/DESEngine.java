...
public class DESEngine implements BlockCipher {
    ...
    private static final byte[] pc1 = {56, 48, 40, RevocationReasonTags.USER_NO_LONGER_VALID, 24, Tnaf.POW_2_WIDTH, 8, 0, 57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34, 26, 18, 10, 2, 59, 51, 43, 35, 62, 54, 46, 38, 30, 22, DataManagerParameterID.LED_ALWAYS_ON, 6, 61, 53, 45, 37, 29, 21, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MAX_THRESHOLD, 5, 60, 52, 44, 36, 28, 20, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD, 4, 27, 19, DataManagerParameterID.ACCELERATION_MAX_RANGE, 3};
    private static final byte[] totrot = {1, 2, 4, 6, 8, 10, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD, DataManagerParameterID.LED_ALWAYS_ON, 15, 17, 19, 21, 23, 25, 27, 28};
    private static final byte[] pc2 = {DataManagerParameterID.DRIVING_TIME_LOW_RPM_MAX_THRESHOLD, Tnaf.POW_2_WIDTH, 10, 23, 0, 4, 2, 27, DataManagerParameterID.LED_ALWAYS_ON, 5, 20, 9, 22, 18, DataManagerParameterID.ACCELERATION_MAX_RANGE, 3, 25, 7, 15, 6, 26, 19, DataManagerParameterID.DRIVING_TIME_LOW_RPM_MIN_THRESHOLD, 1, 40, 51, 30, 36, 46, 54, 29, 39, 50, 44, RevocationReasonTags.USER_NO_LONGER_VALID, 47, 43, 48, 38, 55, 33, 52, 45, 41, 49, 35, 28, 31};
