    ...
    private static class UbiTweak {
        ...
        public void advancePosition(int i) {
            if (this.extendedPosition) {
                ...
                long[] jArr2 = this.tweak;
                jArr[0] = jArr2[0] & BodyPartID.bodyIdMax;
                jArr[1] = (jArr2[0] >>> 32) & BodyPartID.bodyIdMax;
                jArr[2] = jArr2[1] & BodyPartID.bodyIdMax;
                long j = i;
                ...
                jArr3[0] = ((jArr[1] & BodyPartID.bodyIdMax) << 32) | (jArr[0] & BodyPartID.bodyIdMax);
                jArr3[1] = (jArr[2] & BodyPartID.bodyIdMax) | (jArr3[1] & (-4294967296L));
                return;
            }
