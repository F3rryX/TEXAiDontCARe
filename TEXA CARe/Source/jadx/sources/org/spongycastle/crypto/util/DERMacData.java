...
public final class DERMacData {
    ...
    public static final class Builder {
        ...
        public DERMacData build() {
            int i = AnonymousClass1.$SwitchMap$org$spongycastle$crypto$util$DERMacData$Type[this.type.ordinal()];
    ...
    /* JADX INFO: renamed from: org.spongycastle.crypto.util.DERMacData$1, reason: invalid class name */
