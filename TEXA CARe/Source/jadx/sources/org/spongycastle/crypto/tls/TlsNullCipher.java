...
public class TlsNullCipher implements TlsCipher {
    ...
    public TlsNullCipher(TlsContext tlsContext, Digest digest, Digest digest2) throws IOException {
        ...
        if (digest != null) {
            ...
            TlsMac tlsMac3 = new TlsMac(tlsContext, digest, bArrCalculateKeyBlock, 0, digest.getDigestSize());
            int digestSize2 = digest.getDigestSize() + 0;
            tlsMac = new TlsMac(tlsContext, digest2, bArrCalculateKeyBlock, digestSize2, digest2.getDigestSize());
