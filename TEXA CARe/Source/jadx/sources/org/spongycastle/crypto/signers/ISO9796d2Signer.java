...
public class ISO9796d2Signer implements SignerWithRecovery {
    ...
    public void updateWithRecoveredMessage(byte[] bArr) throws InvalidCipherTextException {
        ...
        if ((bArrProcessBlock[0] & RevocationReasonTags.USER_NO_LONGER_VALID) == 0) {
    ...
    public byte[] generateSignature() throws CryptoException {
        ...
        if (i5 > 0) {
            ...
            b = RevocationKeyTags.CLASS_SENSITIVE;
            i2 = length - i4;
        ...
        if (i7 > 0) {
            ...
            bArr5[0] = DataManagerParameterID.ACCELERATION_MAX_RANGE;
        ...
        this.fullMessage = (b & RevocationReasonTags.USER_NO_LONGER_VALID) == 0;
