...
public class ISO9796d2PSSSigner implements SignerWithRecovery {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (this.trailer == 188) {
            this.mBuf = new byte[(((r4.length - this.digest.getDigestSize()) - length) - 1) - 1];
        } else {
            this.mBuf = new byte[(((r4.length - this.digest.getDigestSize()) - length) - 1) - 2];
        }
        reset();
    }
    ...
    public void updateWithRecoveredMessage(byte[] bArr) throws InvalidCipherTextException {
        ...
        int i5 = this.hLen;
        byte[] bArrMaskGeneratorFunction1 = maskGeneratorFunction1(bArrProcessBlock, (length2 - i5) - i3, i5, (bArrProcessBlock.length - i5) - i3);
