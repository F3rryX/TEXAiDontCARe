...
public class PSSSigner implements Signer {
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        int iBitLength = publicKey.getModulus().bitLength() - 1;
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        try {
            ...
            int i = this.hLen;
            byte[] bArrMaskGeneratorFunction1 = maskGeneratorFunction1(bArr4, (length - i) - 1, i, (bArr4.length - i) - 1);
            for (int i2 = 0; i2 != bArrMaskGeneratorFunction1.length; i2++) {
                byte[] bArr5 = this.block;
                bArr5[i2] = (byte) (bArr5[i2] ^ bArrMaskGeneratorFunction1[i2]);
            }
            byte[] bArr6 = this.block;
            ...
            while (true) {
                ...
                if (i3 != ((length2 - i4) - i5) - 2) {
                    ...
                    if (this.sSet) {
                        ...
                        int length3 = ((bArr7.length - i5) - i4) - 1;
                        byte[] bArr10 = this.mDash;
                        System.arraycopy(bArr7, length3, bArr10, bArr10.length - i5, i5);
                    }
                    Digest digest2 = this.contentDigest;
