...
public class Poly1305 implements Mac {
    ...
    private void processBlock() {
        ...
        this.h0 = i3;
        this.h1 = (int) (((long) this.h1) + ((((jLittleEndianToInt2 << 32) | jLittleEndianToInt) >>> 26) & 67108863));
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, DataLengthException {
        ...
        this.h4 = i28;
        long j = (((long) (i24 | (i25 << 26))) & BodyPartID.bodyIdMax) + (((long) this.k0) & BodyPartID.bodyIdMax);
        long j2 = (((long) ((i25 >>> 6) | (i26 << 20))) & BodyPartID.bodyIdMax) + (((long) this.k1) & BodyPartID.bodyIdMax);
        long j3 = (((long) ((i26 >>> 12) | (i27 << 14))) & BodyPartID.bodyIdMax) + (((long) this.k2) & BodyPartID.bodyIdMax);
        long j4 = (((long) ((i27 >>> 18) | (i28 << 8))) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) this.k3));
