...
class PGPExampleUtil {
    ...
    static PGPPublicKey readPublicKey(String str) throws PGPException, IOException {
    ...
    static PGPPublicKey readPublicKey(InputStream inputStream) throws PGPException, IOException {
    ...
    static PGPSecretKey readSecretKey(String str) throws PGPException, IOException {
        BufferedInputStream bufferedInputStream = new BufferedInputStream(new FileInputStream(str));
    ...
    static PGPSecretKey readSecretKey(InputStream inputStream) throws PGPException, IOException {
