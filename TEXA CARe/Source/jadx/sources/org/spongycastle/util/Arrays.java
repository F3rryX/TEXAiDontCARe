...
public final class Arrays {
    ...
    public static int hashCode(int[][] iArr) {
        int iHashCode = 0;
        for (int i = 0; i != iArr.length; i++) {
            iHashCode = (iHashCode * InputDeviceCompat.SOURCE_KEYBOARD) + hashCode(iArr[i]);
        }
        return iHashCode;
    }
    ...
    public static int hashCode(int[] iArr, int i, int i2) {
        ...
        while (true) {
            ...
            i3 = (i3 * InputDeviceCompat.SOURCE_KEYBOARD) ^ iArr[i + i2];
        }
    }
    ...
    public static int hashCode(long[] jArr) {
        ...
        while (true) {
            ...
            long j = jArr[length];
            i = (((i * InputDeviceCompat.SOURCE_KEYBOARD) ^ ((int) j)) * InputDeviceCompat.SOURCE_KEYBOARD) ^ ((int) (j >>> 32));
        }
    }
    ...
    public static int hashCode(long[] jArr, int i, int i2) {
        ...
        while (true) {
            ...
            long j = jArr[i + i2];
            i3 = (((i3 * InputDeviceCompat.SOURCE_KEYBOARD) ^ ((int) j)) * InputDeviceCompat.SOURCE_KEYBOARD) ^ ((int) (j >>> 32));
        }
    }
    ...
    public static int hashCode(short[][][] sArr) {
        int iHashCode = 0;
        for (int i = 0; i != sArr.length; i++) {
            iHashCode = (iHashCode * InputDeviceCompat.SOURCE_KEYBOARD) + hashCode(sArr[i]);
        }
        return iHashCode;
    }
    ...
    public static int hashCode(short[] sArr) {
        ...
        while (true) {
            ...
            i = (i * InputDeviceCompat.SOURCE_KEYBOARD) ^ (sArr[length] & 255);
        }
    }
    ...
    public static int hashCode(Object[] objArr) {
        ...
        while (true) {
            ...
            iHashCode = (iHashCode * InputDeviceCompat.SOURCE_KEYBOARD) ^ objArr[length].hashCode();
        }
    }
    ...
    public static byte[] concatenate(byte[][] bArr) {
        ...
        int length2 = 0;
        for (int i2 = 0; i2 != bArr.length; i2++) {
            System.arraycopy(bArr[i2], 0, bArr2, length2, bArr[i2].length);
