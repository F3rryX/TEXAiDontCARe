...
public class TBSCertificate extends ASN1Object {
    ...
    */
    private TBSCertificate(ASN1Sequence aSN1Sequence) {
        ...
        this.signature = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(i + 2));
        this.issuer = X500Name.getInstance(aSN1Sequence.getObjectAt(i + 3));
        ASN1Sequence aSN1Sequence22 = (ASN1Sequence) aSN1Sequence.getObjectAt(i + 4);
        this.startDate = Time.getInstance(aSN1Sequence22.getObjectAt(0));
        this.endDate = Time.getInstance(aSN1Sequence22.getObjectAt(1));
        this.subject = X500Name.getInstance(aSN1Sequence.getObjectAt(i + 5));
        int i22 = i + 6;
        this.subjectPublicKeyInfo = SubjectPublicKeyInfo.getInstance(aSN1Sequence.getObjectAt(i22));
        size = (aSN1Sequence.size() - i22) - 1;
        if (size == 0) {
        }
        while (size > 0) {
        }
