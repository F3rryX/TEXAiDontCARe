...
/* JADX INFO: loaded from: com.texa.care.apk:org/objectweb/asm/tree/analysis/SimpleVerifier.SCL.lombok */
public class SimpleVerifier extends BasicVerifier {
    ...
    public SimpleVerifier(Type currentClass, Type currentSuperClass, List<Type> currentClassInterfaces, boolean isInterface) {
        this(Opcodes.ASM7, currentClass, currentSuperClass, currentClassInterfaces, isInterface);
