...
/* JADX INFO: loaded from: com.texa.care.apk:org/objectweb/asm/tree/MethodNode.SCL.lombok */
public class MethodNode extends MethodVisitor {
    ...
    public void visitLocalVariable(String name, String descriptor, String signature, Label start, Label end, int index) {
        this.localVariables.add(new LocalVariableNode(name, descriptor, signature, getLabelNode(start), getLabelNode(end), index));
    }
