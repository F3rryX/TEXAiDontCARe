...
/* JADX INFO: loaded from: com.texa.care.apk:org/objectweb/asm/Type.SCL.lombok */
public final class Type {
    ...
    public String getDescriptor() {
        ...
        if (this.sort == 12) {
            return new StringBuilder().append(Matrix.MATRIX_TYPE_RANDOM_LT).append((CharSequence) this.valueBuffer, this.valueBegin, this.valueEnd).append(';').toString();
        }
        return this.valueBuffer.substring(this.valueBegin, this.valueEnd);
    }
    ...
    private void appendDescriptor(StringBuilder stringBuilder) {
        if (this.sort == 10) {
            ...
            stringBuilder.append(Matrix.MATRIX_TYPE_RANDOM_LT).append((CharSequence) this.valueBuffer, this.valueBegin, this.valueEnd).append(';');
        } else {
    ...
    private static void appendDescriptor(Class<?> clazz, StringBuilder stringBuilder) {
        ...
        stringBuilder.append(Matrix.MATRIX_TYPE_RANDOM_LT);
