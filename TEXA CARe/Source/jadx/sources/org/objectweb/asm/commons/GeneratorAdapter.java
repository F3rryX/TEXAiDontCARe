...
/* JADX INFO: loaded from: com.texa.care.apk:org/objectweb/asm/commons/GeneratorAdapter.SCL.lombok */
public class GeneratorAdapter extends LocalVariablesSorter {
    ...
    public GeneratorAdapter(int access, Method method, String signature, Type[] exceptions, ClassVisitor classVisitor) {
        this(access, method, classVisitor.visitMethod(access, method.getName(), method.getDescriptor(), signature, getInternalNames(exceptions)));
    }
    ...
    public void invokeVirtual(Type owner, Method method) {
        invokeInsn(182, owner, method, false);
    }
    ...
    public void invokeStatic(Type owner, Method method) {
        invokeInsn(184, owner, method, false);
    }

    public void invokeInterface(Type owner, Method method) {
        invokeInsn(185, owner, method, true);
    }
