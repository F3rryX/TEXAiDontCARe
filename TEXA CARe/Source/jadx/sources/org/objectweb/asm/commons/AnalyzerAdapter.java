...
/* JADX INFO: loaded from: com.texa.care.apk:org/objectweb/asm/commons/AnalyzerAdapter.SCL.lombok */
public class AnalyzerAdapter extends MethodVisitor {
    ...
    public void visitMultiANewArrayInsn(String descriptor, int numDimensions) {
        ...
        execute(197, numDimensions, descriptor);
    }
    ...
    private void pushDescriptor(String descriptor) {
        int index = descriptor.charAt(0) == '(' ? descriptor.indexOf(41) + 1 : 0;
