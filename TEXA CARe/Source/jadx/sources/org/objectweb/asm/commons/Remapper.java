...
/* JADX INFO: loaded from: com.texa.care.apk:org/objectweb/asm/commons/Remapper.SCL.lombok */
public abstract class Remapper {
    ...
    public String mapInnerClassName(String name, String ownerName, String innerName) {
        ...
        if (remappedInnerName.contains("$")) {
            return remappedInnerName.substring(remappedInnerName.lastIndexOf(36) + 1);
        }
        return innerName;
    }
