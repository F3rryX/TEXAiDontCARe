...
/* JADX INFO: loaded from: com.texa.care.apk:org/objectweb/asm/commons/Method.SCL.lombok */
public class Method {
    ...
    private static String getDescriptorInternal(String type, boolean defaultPackage) {
        ...
        while (true) {
            int iIndexOf = type.indexOf(HttpUrl.PATH_SEGMENT_ENCODE_SET_URI, arrayBracketsIndex) + 1;
