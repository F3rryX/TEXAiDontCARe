...
/* JADX INFO: loaded from: com.texa.care.apk:org/objectweb/asm/commons/SignatureRemapper.SCL.lombok */
public class SignatureRemapper extends SignatureVisitor {
    ...
    public void visitInnerClassType(String name) {
        ...
        String className = outerClassName + Typography.dollar + name;
        this.classNames.add(className);
        String remappedOuter = this.remapper.mapType(outerClassName) + Typography.dollar;
