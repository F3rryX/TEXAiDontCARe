...
/* JADX INFO: loaded from: com.texa.care.apk:org/objectweb/asm/commons/RemappingMethodAdapter.SCL.lombok */
@Deprecated
public class RemappingMethodAdapter extends LocalVariablesSorter {
    ...
    public void visitFrame(int type, int numLocal, Object[] local, int numStack, Object[] stack) {
        super.visitFrame(type, numLocal, remapEntries(numLocal, local), numStack, remapEntries(numStack, stack));
    }
