...
/* JADX INFO: loaded from: com.texa.care.apk:org/objectweb/asm/ClassReader.SCL.lombok */
public class ClassReader {
        ...
        while (currentOffset < bytecodeEndOffset) {
            ...
            switch (classFileBuffer[currentOffset] & 255) {
                ...
                case 197:
                    ...
                    break;
                case 200:
                case com.texa.careapp.Constants.PENDING_INTENT_REQUEST_CODE_ODOMETER_CONFIRM /* 201 */:
                case Commands.DPMC_GetCreationDate /* 220 */:
                    createLabel(bytecodeOffset + readInt(currentOffset + 1), labels);
                    currentOffset += 5;
                    break;
                case com.texa.careapp.Constants.PENDING_INTENT_REQUEST_CODE_CONFIGURATION_UPGRADE /* 202 */:
                case com.texa.careapp.Constants.PENDING_INTENT_REQUEST_CODE_ATTITUDE /* 203 */:
                case com.texa.careapp.Constants.PENDING_INTENT_REQUEST_CODE_PIN_CONFIRM /* 204 */:
                case com.texa.careapp.Constants.PENDING_INTENT_REQUEST_CODE_LOGIN_AFTER_REFRESH_TOKEN_EXPIRED /* 205 */:
                case 206:
                case 207:
                case Commands.DPM_GetStatus /* 208 */:
                case Commands.DPM_Start /* 209 */:
                case Commands.DPM_Stop /* 210 */:
                case 211:
                case Commands.DPM_Exit /* 212 */:
                case Commands.DPMT_GetMasterRequest /* 213 */:
                case Commands.DPMT_SendSlaveRequest /* 214 */:
                case Commands.DPMC_GetSupportedDiagnosticProcedures /* 215 */:
                case Commands.DPMC_SetUserCode /* 216 */:
                case Commands.DPMC_SetUnlockCode /* 217 */:
                case Commands.DPMT_SetNotification /* 218 */:
                case Commands.DPMT_NotifySlaveEvent /* 219 */:
    ...
    private int[] readTypeAnnotations(MethodVisitor methodVisitor, Context context, int runtimeTypeAnnotationsOffset, boolean visible) {
        ...
        for (int i = 0; i < typeAnnotationsOffsets.length; i++) {
            ...
            if ((targetType >>> 24) == 66) {
                ...
                elementValues = readElementValues(methodVisitor.visitTryCatchAnnotation(targetType & InputDeviceCompat.SOURCE_ANY, path, annotationDescriptor, visible), currentOffset3 + 2, true, charBuffer);
            } else {
    ...
    private int readTypeAnnotationTarget(Context context, int typeAnnotationOffset) {
        ...
        switch (targetType2 >>> 24) {
            ...
            case 23:
            case 66:
                targetType = targetType2 & InputDeviceCompat.SOURCE_ANY;
                currentOffset = typeAnnotationOffset + 3;
                break;
            case 19:
            case 20:
            case 21:
                targetType = targetType2 & ViewCompat.MEASURED_STATE_MASK;
    ...
    public long readLong(int offset) {
        ...
        long l0 = ((long) readInt(offset + 4)) & BodyPartID.bodyIdMax;
        return (l1 << 32) | l0;
    }
    ...
    private String readUtf(int utfOffset, int utfLength, char[] charBuffer) {
        ...
        while (currentOffset < endOffset) {
            ...
            if ((b & 128) == 0) {
                int i2 = strLength;
                strLength++;
                charBuffer[i2] = (char) (b & ByteCompanionObject.MAX_VALUE);
            } else if ((b & 224) == 192) {
                int i3 = strLength;
                strLength++;
                currentOffset++;
                charBuffer[i3] = (char) (((b & 31) << 6) + (classFileBuffer[currentOffset] & Utf8.REPLACEMENT_BYTE));
            } else {
                int i4 = strLength;
                strLength++;
                int currentOffset2 = currentOffset + 1;
                int i5 = ((b & 15) << 12) + ((classFileBuffer[currentOffset] & Utf8.REPLACEMENT_BYTE) << 6);
                currentOffset = currentOffset2 + 1;
                charBuffer[i4] = (char) (i5 + (classFileBuffer[currentOffset2] & Utf8.REPLACEMENT_BYTE));
            }
        }
