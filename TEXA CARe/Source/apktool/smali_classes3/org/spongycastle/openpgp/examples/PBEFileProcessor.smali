...
.method private static decryptFile(Ljava/io/InputStream;[C)V
    ...
    invoke-virtual {v0, v2}, Lorg/spongycastle/openpgp/operator/jcajce/JcePBEDataDecryptorFactoryBuilder;->setProvider(Ljava/lang/String;)Lorg/spongycastle/openpgp/operator/jcajce/JcePBEDataDecryptorFactoryBuilder;
...
.method private static encryptFile(Ljava/io/OutputStream;Ljava/lang/String;[CZZ)V
    ...
    .line 152
    new-instance v1, Lorg/spongycastle/bcpg/ArmoredOutputStream;

    invoke-direct {v1, p0}, Lorg/spongycastle/bcpg/ArmoredOutputStream;-><init>(Ljava/io/OutputStream;)V
    ...
    .line 157
    :try_start_0
    invoke-static {p1, v1}, Lorg/spongycastle/openpgp/examples/PGPExampleUtil;->compressFile(Ljava/lang/String;I)[B
    ...
    invoke-direct {v2, v3}, Lorg/spongycastle/openpgp/operator/jcajce/JcePGPDataEncryptorBuilder;-><init>(I)V

    .line 160
    invoke-virtual {v2, p4}, Lorg/spongycastle/openpgp/operator/jcajce/JcePGPDataEncryptorBuilder;->setWithIntegrityPacket(Z)Lorg/spongycastle/openpgp/operator/jcajce/JcePGPDataEncryptorBuilder;
    ...
    invoke-virtual {p4, v2}, Lorg/spongycastle/openpgp/operator/jcajce/JcePGPDataEncryptorBuilder;->setSecureRandom(Ljava/security/SecureRandom;)Lorg/spongycastle/openpgp/operator/jcajce/JcePGPDataEncryptorBuilder;

    move-result-object p4

    invoke-virtual {p4, v0}, Lorg/spongycastle/openpgp/operator/jcajce/JcePGPDataEncryptorBuilder;->setProvider(Ljava/lang/String;)Lorg/spongycastle/openpgp/operator/jcajce/JcePGPDataEncryptorBuilder;

    move-result-object p4

    invoke-direct {v1, p4}, Lorg/spongycastle/openpgp/PGPEncryptedDataGenerator;-><init>(Lorg/spongycastle/openpgp/operator/PGPDataEncryptorBuilder;)V
    ...
    invoke-virtual {p4, v0}, Lorg/spongycastle/openpgp/operator/jcajce/JcePBEKeyEncryptionMethodGenerator;->setProvider(Ljava/lang/String;)Lorg/spongycastle/openpgp/operator/jcajce/JcePBEKeyEncryptionMethodGenerator;

    move-result-object p2

    invoke-virtual {v1, p2}, Lorg/spongycastle/openpgp/PGPEncryptedDataGenerator;->addMethod(Lorg/spongycastle/openpgp/operator/PGPKeyEncryptionMethodGenerator;)V
    ...
    invoke-virtual {v1, p0, v2, v3}, Lorg/spongycastle/openpgp/PGPEncryptedDataGenerator;->open(Ljava/io/OutputStream;J)Ljava/io/OutputStream;
