...
.method protected encryptSessionInfo(Lorg/spongycastle/openpgp/PGPPublicKey;[B)[B
    ...
    invoke-static {v2}, Lorg/spongycastle/openpgp/operator/jcajce/PGPUtil;->getX9Parameters(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;)Lorg/spongycastle/asn1/x9/X9ECParameters;
    ...
    invoke-virtual {v4, v0}, Lorg/spongycastle/openpgp/operator/jcajce/OperatorHelper;->createAlgorithmParameters(Ljava/lang/String;)Ljava/security/AlgorithmParameters;
    ...
    invoke-direct {v5, v6}, Lorg/spongycastle/asn1/x9/X962Parameters;-><init>(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;)V

    invoke-virtual {v5}, Lorg/spongycastle/asn1/x9/X962Parameters;->getEncoded()[B
    ...
    .line 102
    iget-object v5, p0, Lorg/spongycastle/openpgp/operator/jcajce/JcePublicKeyKeyEncryptionMethodGenerator;->helper:Lorg/spongycastle/openpgp/operator/jcajce/OperatorHelper;

    invoke-virtual {v5, v0}, Lorg/spongycastle/openpgp/operator/jcajce/OperatorHelper;->createKeyPairGenerator(Ljava/lang/String;)Ljava/security/KeyPairGenerator;
    ...
    invoke-virtual {v4, p1, v3}, Ljavax/crypto/KeyAgreement;->doPhase(Ljava/security/Key;Z)Ljava/security/Key;
    ...
    invoke-virtual {v4, v1}, Lorg/spongycastle/openpgp/operator/jcajce/OperatorHelper;->createKeyWrapper(I)Ljavax/crypto/Cipher;
    ...
    invoke-virtual {v1, v4, p1, v5}, Ljavax/crypto/Cipher;->init(ILjava/security/Key;Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {v1, v4}, Ljavax/crypto/Cipher;->wrap(Ljava/security/Key;)[B
    ...
    invoke-virtual {v0, v3, p1, v1}, Ljavax/crypto/Cipher;->init(ILjava/security/Key;Ljava/security/SecureRandom;)V
