...
.method public calculateFingerprint(Lorg/spongycastle/bcpg/PublicKeyPacket;)[B
    ...
    invoke-direct {v1, v4}, Lorg/spongycastle/bcpg/MPInteger;-><init>(Ljava/math/BigInteger;)V
    ...
    invoke-interface {p1, v1, v5, v4}, Lorg/spongycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {p1, v0, v5, v1}, Lorg/spongycastle/crypto/Digest;->update([BII)V
    :try_end_0
