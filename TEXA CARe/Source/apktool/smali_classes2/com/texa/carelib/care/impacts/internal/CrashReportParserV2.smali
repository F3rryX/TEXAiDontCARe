.class public Lcom/texa/carelib/care/impacts/internal/CrashReportParserV2;
.super Lcom/texa/carelib/profile/internal/CareStructParser;
.source "CrashReportParserV2.java"
...
.field private static final INDEX_CLIENT_DEVICE_CONNECTED:I = 0x7

.field private static final INDEX_DETECTED:I = 0xc

.field private static final INDEX_INTENSITY:I = 0xe

.field private static final INDEX_RESERVED:I = 0x14
...
.method public parse([B)Lcom/texa/carelib/care/impacts/CrashReport;
    ...
    .line 43
    invoke-virtual {p0, p1}, Lcom/texa/carelib/care/impacts/internal/CrashReportParserV2;->parseBlockVersion([B)I
    ...
    .line 44
    invoke-virtual {p0, p1}, Lcom/texa/carelib/care/impacts/internal/CrashReportParserV2;->parseCrashID([B)J
    ...
    .line 45
    invoke-virtual {p0, p1}, Lcom/texa/carelib/care/impacts/internal/CrashReportParserV2;->parseTimestamp([B)Ljava/util/Date;
    ...
    .line 46
    invoke-virtual {p0, p1}, Lcom/texa/carelib/care/impacts/internal/CrashReportParserV2;->parseCrashReportStatus([B)Lcom/texa/carelib/care/impacts/CrashReportStatus;
    ...
    .line 47
    invoke-virtual {p0, p1}, Lcom/texa/carelib/care/impacts/internal/CrashReportParserV2;->parseIsClientDeviceConnected([B)Ljava/lang/Boolean;
    ...
    .line 48
    invoke-virtual {p0, p1}, Lcom/texa/carelib/care/impacts/internal/CrashReportParserV2;->parseTripNumber([B)Ljava/lang/Long;

    move-result-object p1

    invoke-virtual {v1, p1}, Lcom/texa/carelib/care/impacts/internal/CrashReportBuilder;->setTripNumber(Ljava/lang/Long;)Lcom/texa/carelib/care/impacts/internal/CrashReportBuilder;
...
.method public bridge synthetic parse([B)Ljava/lang/Object;
    ...
    .line 18
    invoke-virtual {p0, p1}, Lcom/texa/carelib/care/impacts/internal/CrashReportParserV2;->parse([B)Lcom/texa/carelib/care/impacts/CrashReport;
...
.method protected parseBlockVersion([B)I
    ...
    .line 61
    invoke-virtual {p0, p1, v0}, Lcom/texa/carelib/care/impacts/internal/CrashReportParserV2;->getUnsignedByte([BI)Ljava/lang/Short;
...
.method protected parseCrashID([B)J
    ...
    .line 103
    invoke-virtual {p0, p1, v0}, Lcom/texa/carelib/care/impacts/internal/CrashReportParserV2;->getUnsignedInt([BI)Ljava/lang/Long;
...
.method protected parseTimestamp([B)Ljava/util/Date;
    ...
    .line 112
    invoke-virtual {p0, p1, v0}, Lcom/texa/carelib/care/impacts/internal/CrashReportParserV2;->getTimestamp([BI)Ljava/util/Date;
...
.method protected parseTripNumber([B)Ljava/lang/Long;
    ...
    .line 78
    invoke-virtual {p0, p1, v0}, Lcom/texa/carelib/care/impacts/internal/CrashReportParserV2;->getUnsignedChar([BI)Ljava/lang/Integer;
