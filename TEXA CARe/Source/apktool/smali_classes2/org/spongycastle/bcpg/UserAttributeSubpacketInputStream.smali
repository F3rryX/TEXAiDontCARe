...
.method public readPacket()Lorg/spongycastle/bcpg/UserAttributeSubpacket;
    ...
    .line 108
    invoke-direct {p0, v5, v1, v0}, Lorg/spongycastle/bcpg/UserAttributeSubpacketInputStream;->readFully([BII)V

    if-eq v4, v2, :cond_3

    .line 118
    new-instance v0, Lorg/spongycastle/bcpg/UserAttributeSubpacket;

    invoke-direct {v0, v4, v3, v5}, Lorg/spongycastle/bcpg/UserAttributeSubpacket;-><init>(IZ[B)V
    ...
    invoke-direct {v0, v3, v5}, Lorg/spongycastle/bcpg/attr/ImageAttribute;-><init>(Z[B)V
